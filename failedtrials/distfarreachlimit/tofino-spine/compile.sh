...
./configure --prefix=$SDE_INSTALL --with-tofino P4_NAME=distfarreachlimitspine P4_PATH=/home/${USER}/${SWITCH_ROOTPATH}/distfarreachlimit/tofino-spine/distfarreachlimitspine.p4  enable_thrift=yes  P4_VERSION=p4-14
make
make install
