...
from distfarreachlimitleaf.p4_pd_rpc.ttypes import *
...
class TableConfigure(pd_base_tests.ThriftInterfaceDataPlane):
    def __init__(self):
        ...
        pd_base_tests.ThriftInterfaceDataPlane.__init__(self, ["distfarreachlimitleaf"])
...
#                    matchspec0 = eval("distfarreachlimitleaf_update_val{}_tbl_match_spec_t".format(valname))(
...
#            self.mirror.mirror_session_create(self.sess_hdl, self.dev_tgt, info)
            ...
            for i in range(client_physical_num):
                matchspec0 = distfarreachlimitleaf_l2l3_forward_tbl_match_spec_t(\
                ...
                actnspec0 = distfarreachlimitleaf_l2l3_forward_action_spec_t(self.client_devports[i])
            ...
            for i in range(server_physical_num):
                matchspec0 = distfarreachlimitleaf_l2l3_forward_tbl_match_spec_t(\
                        ...
                        ipv4_hdr_dstAddr_prefix_length = 32)
                actnspec0 = distfarreachlimitleaf_l2l3_forward_action_spec_t(self.server_devports[i])
                self.client.l2l3_forward_tbl_table_add_with_l2l3_forward(\
                        self.sess_hdl, self.dev_tgt, matchspec0, actnspec0)
            ...
            actnspec0 = distfarreachlimitleaf_set_hot_threshold_action_spec_t(hot_threshold)
            ...
            for tmpoptype in [GETREQ, PUTREQ, DELREQ, SCANREQ, WARMUPREQ, LOADREQ, GETRES_LATEST_SEQ_SERVER, GETRES_DELETED_SEQ_SERVER, GETRES_LATEST_SEQ_SERVER_INSWITCH, GETRES_DELETED_SEQ_SERVER_INSWITCH]:
                matchspec0 = distfarreachlimitleaf_hash_for_spineselect_tbl_match_spec_t(\
            ...
            for tmpoptype in [PUTREQ_SEQ, DELREQ_SEQ, GETRES_LATEST_SEQ_SERVER, GETRES_DELETED_SEQ_SERVER]:
                matchspec0 = distfarreachlimitleaf_recirculate_tbl_match_spec_t(\
                        op_hdr_optype = tmpoptype,
                        meta_need_recirculate = 1)
                # forward to the first spine switch for atomicity of setting snapshot flag
                actnspec0 = distfarreachlimitleaf_recirculate_pkt_action_spec_t(self.spineswitch_devport)
            ...
            if RANGE_SUPPORT == False:
                ...
                for tmpoptype in [GETREQ_SPINE, CACHE_POP_INSWITCH, PUTREQ_SEQ, DELREQ_SEQ, WARMUPREQ_SPINE, LOADREQ_SPINE, CACHE_EVICT_LOADFREQ_INSWITCH, CACHE_EVICT_LOADDATA_INSWITCH, LOADSNAPSHOTDATA_INSWITCH, SETVALID_INSWITCH, PUTREQ_SEQ_INSWITCH, DELREQ_SEQ_INSWITCH, GETRES_LATEST_SEQ_SERVER, GETRES_DELETED_SEQ_SERVER, GETRES_LATEST_SEQ_SERVER_INSWITCH, GETRES_DELETED_SEQ_SERVER_INSWITCH, GETREQ_NLATEST]:
                    matchspec0 = distfarreachlimitleaf_hash_for_partition_tbl_match_spec_t(\
                            op_hdr_optype = convert_u16_to_i16(tmpoptype),
            ...
            for tmpoptype in [GETREQ, PUTREQ, DELREQ, SCANREQ, WARMUPREQ, LOADREQ, GETRES_LATEST_SEQ_SERVER, GETRES_DELETED_SEQ_SERVER, GETRES_LATEST_SEQ_SERVER_INSWITCH, GETRES_DELETED_SEQ_SERVER_INSWITCH]:
                ...
                for i in range(spineswitch_total_logical_num):
                    ...
                    matchspec0 = distfarreachlimitleaf_spineselect_tbl_match_spec_t(\
                            op_hdr_optype = tmpoptype,
                    ...
                    if tmpoptype == GETRES_LATEST_SEQ_SERVER or tmpoptype == GETRES_DELETED_SEQ_SERVER or tmpoptype == GETRES_LATEST_SEQ_SERVER_INSWITCH or tmpoptype == GETRES_DELETED_SEQ_SERVER_INSWITCH:
                        actnspec0 = distfarreachlimitleaf_spineselect_for_special_response_action_spec_t(global_spineswitch_logical_idx)
                        ...
                        actnspec0 = distfarreachlimitleaf_spineselect_action_spec_t(eport, global_spineswitch_logical_idx)
            ...
            if RANGE_SUPPORT == True:
                ...
                for tmpoptype in [GETREQ_SPINE, CACHE_POP_INSWITCH, PUTREQ_SEQ, DELREQ_SEQ, WARMUPREQ_SPINE, SCANREQ_SPLIT, LOADREQ_SPINE, CACHE_EVICT_LOADFREQ_INSWITCH, CACHE_EVICT_LOADDATA_INSWITCH, LOADSNAPSHOTDATA_INSWITCH, SETVALID_INSWITCH, PUTREQ_SEQ_INSWITCH, DELREQ_SEQ_INSWITCH, GETRES_LATEST_SEQ_SERVER, GETRES_DELETED_SEQ_SERVER, GETRES_LATEST_SEQ_SERVER_INSWITCH, GETRES_DELETED_SEQ_SERVER_INSWITCH, GETREQ_NLATEST]:
                    ...
                    for i in range(leafswitch_total_logical_num):
                        ...
                        for j in range(servernum_per_leafswitch):
                            ...
                            # NOTE: both start and end are included
                            matchspec0 = distfarreachlimitleaf_range_partition_tbl_match_spec_t(\
                                    op_hdr_optype = tmpoptype,
                            ...
                            if server_physical_idx == -1:
                                ...
                                if tmpoptype == GETRES_LATEST_SEQ_SERVER or tmpoptype == GETRES_DELETED_SEQ_SERVER or tmpoptype == GETRES_LATEST_SEQ_SERVER_INSWITCH or tmpoptype == GETRES_DELETED_SEQ_SERVER_INSWITCH:
                                    actnspec0 = distfarreachlimitleaf_range_partition_for_special_response_action_spec_t(eport)
                                    self.client.range_partition_tbl_table_add_with_range_partition_for_special_response(\
                                            self.sess_hdl, self.dev_tgt, matchspec0, 0, actnspec0) # 0 is priority (range may be overlapping)
                                elif tmpoptype != SCANREQ_SPLIT:
                                    actnspec0 = distfarreachlimitleaf_range_partition_action_spec_t(udp_dstport, eport)
                                    self.client.range_partition_tbl_table_add_with_range_partition(\
                                            self.sess_hdl, self.dev_tgt, matchspec0, 0, actnspec0) # 0 is priority (range may be overlapping)
                                else:
                                    actnspec0 = distfarreachlimitleaf_range_partition_for_scan_action_spec_t(udp_dstport, eport, global_server_logical_idx)
                ...
                for tmpoptype in [GETREQ_SPINE, CACHE_POP_INSWITCH, PUTREQ_SEQ, DELREQ_SEQ, WARMUPREQ_SPINE, LOADREQ_SPINE, CACHE_EVICT_LOADFREQ_INSWITCH, CACHE_EVICT_LOADDATA_INSWITCH, LOADSNAPSHOTDATA_INSWITCH, SETVALID_INSWITCH, PUTREQ_SEQ_INSWITCH, DELREQ_SEQ_INSWITCH, GETRES_LATEST_SEQ_SERVER, GETRES_DELETED_SEQ_SERVER, GETRES_LATEST_SEQ_SERVER_INSWITCH, GETRES_DELETED_SEQ_SERVER_INSWITCH, GETREQ_NLATEST]:
                    ...
                    for global_server_logical_idx in range(server_total_logical_num):
                        ...
                        # NOTE: both start and end are included
                        matchspec0 = distfarreachlimitleaf_hash_partition_tbl_match_spec_t(\
                                op_hdr_optype = convert_u16_to_i16(tmpoptype),
                        ...
                        if server_physical_idx == -1:
                            ...
                            eport = self.server_devports[server_physical_idx]
                            if tmpoptype == GETRES_LATEST_SEQ_SERVER or tmpoptype == GETRES_DELETED_SEQ_SERVER or tmpoptype == GETRES_LATEST_SEQ_SERVER_INSWITCH or tmpoptype == GETRES_DELETED_SEQ_SERVER_INSWITCH:
                                actnspec0 = distfarreachlimitleaf_hash_partition_for_special_response_action_spec_t(eport)
                                self.client.hash_partition_tbl_table_add_with_hash_partition_for_special_response(\
                                        self.sess_hdl, self.dev_tgt, matchspec0, 0, actnspec0) # 0 is priority (range may be overlapping)
                            else:
                                actnspec0 = distfarreachlimitleaf_hash_partition_action_spec_t(udp_dstport, eport)
            ...
            if RANGE_SUPPORT == True:
                ...
                for i in range(leafswitch_total_logical_num):
                    ...
                    for j in range(servernum_per_leafswitch):
                        ...
                        # NOTE: both start and end are included
                        matchspec0 = distfarreachlimitleaf_range_partition_for_scan_endkey_tbl_match_spec_t(\
                        ...
                        actnspec0 = distfarreachlimitleaf_range_partition_for_scan_endkey_action_spec_t(end_globalserveridx_plus_one)
            ...
            for funcname in ["12", "34"]:
                ...
                for tmpoptype in [GETREQ_SPINE, PUTREQ_SEQ, PUTREQ_SEQ_INSWITCH]:
                    matchspec0 = eval("distfarreachlimitleaf_hash_for_cm{}_tbl_match_spec_t".format(funcname))(\
                            op_hdr_optype = tmpoptype,
                            meta_need_recirculate = 0)
            ...
            for tmpoptype in [PUTREQ_SEQ_INSWITCH, DELREQ_SEQ_INSWITCH, GETRES_LATEST_SEQ_SERVER_INSWITCH, GETRES_DELETED_SEQ_SERVER_INSWITCH]:
                matchspec0 = distfarreachlimitleaf_snapshot_flag_tbl_match_spec_t(\
                        op_hdr_optype = tmpoptype,
                        meta_need_recirculate = 0)
            ...
            for client_physical_idx in range(client_physical_num):
                ...
                for tmpoptype in [GETREQ_SPINE, PUTREQ_SEQ, DELREQ_SEQ, PUTREQ_SEQ_INSWITCH, DELREQ_SEQ_INSWITCH]:
                    matchspec0 = distfarreachlimitleaf_prepare_for_cachehit_tbl_match_spec_t(\
                            op_hdr_optype = tmpoptype,
                            ...
                            meta_need_recirculate = 0)
                    actnspec0 = distfarreachlimitleaf_set_client_sid_action_spec_t(self.spineswitch_sid)
            ...
            for is_cached in cached_list:
                for tmp_client_physical_idx in range(client_physical_num):
                    ...
                    for tmpoptype in [GETRES, PUTRES, DELRES, WARMUPACK, SCANRES_SPLIT, LOADACK]:
                        matchspec0 = distfarreachlimitleaf_ipv4_forward_tbl_match_spec_t(\
                                op_hdr_optype = convert_u16_to_i16(tmpoptype),
                                ipv4_hdr_dstAddr = ipv4addr0,
                                ipv4_hdr_dstAddr_prefix_length = 32,
                                inswitch_hdr_is_cached = is_cached,
                                meta_need_recirculate = 0) # NOTE: meta.need_recirculate must be 0 for those packets
                        actnspec0 = distfarreachlimitleaf_forward_normal_response_action_spec_t(eport)
                    ...
                    for tmpoptype in [GETRES_LATEST_SEQ_SERVER, GETRES_DELETED_SEQ_SERVER, GETRES_LATEST_SEQ_SERVER_INSWITCH, GETRES_DELETED_SEQ_SERVER_INSWITCH]:
                        matchspec0 = distfarreachlimitleaf_ipv4_forward_tbl_match_spec_t(\
                                ...
                                meta_need_recirculate = 0)
                        if is_cached == 0:
                            actnspec0 = distfarreachlimitleaf_forward_special_get_response_to_spine_action_spec_t(eport)
                            self.client.ipv4_forward_tbl_table_add_with_forward_special_get_response_to_spine(\
                                    self.sess_hdl, self.dev_tgt, matchspec0, actnspec0)
                        elif is_cached == 1:
                            actnspec0 = distfarreachlimitleaf_forward_special_get_response_to_server_and_clone_to_spine_action_spec_t(tmpsid)
            ...
            for tmpoptype in [GETREQ_SPINE, PUTREQ_SEQ, PUTREQ_SEQ_INSWITCH]:
                matchspec0 = distfarreachlimitleaf_sample_tbl_match_spec_t(\
                        op_hdr_optype = tmpoptype,
                        meta_need_recirculate = 0)
            ...
            matchspec0 = distfarreachlimitleaf_ig_port_forward_tbl_match_spec_t(\
            ...
            for i in range(1, cm_hashnum+1):
                ...
                for tmpoptype in [GETREQ_INSWITCH, PUTREQ_SEQ_INSWITCH]:
                    matchspec0 = eval("distfarreachlimitleaf_access_cm{}_tbl_match_spec_t".format(i))(\
                            op_hdr_optype = tmpoptype,
            ...
            if RANGE_SUPPORT:
                ...
                for is_clone in [0, 1]:
                    for global_server_logical_idx in range(server_total_logical_num):
                        ...
                        matchspec0 = distfarreachlimitleaf_process_scanreq_split_tbl_match_spec_t(\
                                op_hdr_optype = SCANREQ_SPLIT,
                        ...
                        if is_clone == 0:
                            ...
                            if server_physical_idx == -1:
                                ...
                                actnspec0 = distfarreachlimitleaf_process_scanreq_split_action_spec_t(tmp_server_sid)
                            ...
                            if current_local_server_logical_idx == -1 or next_server_physical_idx == -1:
                                ...
                                actnspec0 = distfarreachlimitleaf_process_cloned_scanreq_split_action_spec_t(tmp_udpport, tmp_server_sid)
            ...
            matchspec0 = distfarreachlimitleaf_is_hot_tbl_match_spec_t(\
            ...
            for tmpoptype in [GETREQ_INSWITCH, PUTREQ_SEQ_INSWITCH]:
                matchspec0 = distfarreachlimitleaf_access_cache_frequency_tbl_match_spec_t(\
                        op_hdr_optype = tmpoptype,
                        inswitch_hdr_is_sampled = 1,
            ...
            for tmpoptype in [GETREQ_INSWITCH, GETRES_LATEST_SEQ_INSWITCH, GETRES_DELETED_SEQ_INSWITCH, PUTREQ_SEQ_INSWITCH, DELREQ_SEQ_INSWITCH]:
                matchspec0 = distfarreachlimitleaf_access_validvalue_tbl_match_spec_t(\
                        op_hdr_optype = tmpoptype,
                        inswitch_hdr_is_cached = 1)
            ...
            for tmpoptype in[GETREQ_INSWITCH, PUTREQ_SEQ_INSWITCH, DELREQ_SEQ_INSWITCH]:
                matchspec0 = distfarreachlimitleaf_save_client_info_tbl_match_spec_t(\
                        op_hdr_optype = tmpoptype)
            ...
            for is_cached in cached_list:
                for validvalue in validvalue_list:
                    matchspec0 = distfarreachlimitleaf_access_latest_tbl_match_spec_t(\
                            op_hdr_optype = GETREQ_INSWITCH,
                            inswitch_hdr_is_cached = is_cached,
                            validvalue_hdr_validvalue = validvalue)
                    if is_cached == 1:
                ...
                for validvalue in validvalue_list:
                    for is_latest in latest_list:
                        for is_stat in stat_list:
                            matchspec0 = distfarreachlimitleaf_access_deleted_tbl_match_spec_t(\
                                    op_hdr_optype = GETREQ_INSWITCH,
                                    inswitch_hdr_is_cached = is_cached,
                                    validvalue_hdr_validvalue = validvalue,
                                    meta_is_latest = is_latest,
            ...
            for is_cached in cached_list:
                for validvalue in validvalue_list:
                    for is_latest in latest_list:
                        matchspec0 = distfarreachlimitleaf_update_vallen_tbl_match_spec_t(\
                                op_hdr_optype = GETREQ_INSWITCH,
                                inswitch_hdr_is_cached = is_cached,
                                validvalue_hdr_validvalue = validvalue,
                                meta_is_latest = is_latest)
            ...
            for is_cached in cached_list:
                for validvalue in validvalue_list:
                    for is_latest in latest_list:
                        for tmpoptype in [PUTREQ_SEQ_INSWITCH, DELREQ_SEQ_INSWITCH]:
                            matchspec0 = distfarreachlimitleaf_access_savedseq_tbl_match_spec_t(\
                                    op_hdr_optype = tmpoptype,
                                    inswitch_hdr_is_cached = is_cached,
                                    validvalue_hdr_validvalue = validvalue,
                                    meta_is_latest = is_latest)
            ...
            for is_latest in latest_list:
                for tmpoptype in [GETRES_LATEST_SEQ_INSWITCH, GETRES_DELETED_SEQ_INSWITCH]:
                    matchspec0 = distfarreachlimitleaf_access_case1_tbl_match_spec_t(\
                            op_hdr_optype = tmpoptype,
                            inswitch_hdr_is_cached = 1,
            ...
            if RANGE_SUPPORT == False:
                ...
                for tmpoptype in [GETRES_LATEST_SEQ_INSWITCH_CASE1, GETRES_DELETED_SEQ_INSWITCH_CASE1, PUTREQ_SEQ_INSWITCH_CASE1, DELREQ_SEQ_INSWITCH_CASE1]:
                    matchspec0 = distfarreachlimitleaf_lastclone_lastscansplit_tbl_match_spec_t(\
                            op_hdr_optype = tmpoptype,
            ...
            # Table; another_eg_port_forward_tbl (default: nop; size: < 4096)
            print "Configuring eg_port_forward_tbl"
            self.configure_another_eg_port_forward_tbl()

            # Stage 9

            # Table: eg_port_forward_tbl (default: nop; size: < 2048 < 4096)
            print "Configuring eg_port_forward_tbl"
            if RANGE_SUPPORT == False:
            ...
            for i in range(switch_max_vallen/8 + 1): # i from 0 to 16
                ...
                matchspec0 = distfarreachlimitleaf_update_pktlen_tbl_match_spec_t(\
                        op_hdr_optype=GETRES,
                        vallen_hdr_vallen_start=vallen_start,
                        vallen_hdr_vallen_end=vallen_end) # [vallen_start, vallen_end]
                actnspec0 = distfarreachlimitleaf_update_pktlen_action_spec_t(val_stat_udplen, val_stat_iplen)
                ...
                for tmpoptype in [GETRES_LATEST_SEQ_INSWITCH_CASE1, GETRES_DELETED_SEQ_INSWITCH_CASE1, PUTREQ_SEQ_INSWITCH_CASE1, DELREQ_SEQ_INSWITCH_CASE1]:
                    matchspec0 = distfarreachlimitleaf_update_pktlen_tbl_match_spec_t(\
                            ...
                            vallen_hdr_vallen_start=vallen_start,
                            vallen_hdr_vallen_end=vallen_end) # [vallen_start, vallen_end]
                    actnspec0 = distfarreachlimitleaf_update_pktlen_action_spec_t(val_seq_inswitch_stat_clone_udplen, val_seq_inswitch_stat_clone_iplen)
                    self.client.update_pktlen_tbl_table_add_with_update_pktlen(\
                            self.sess_hdl, self.dev_tgt, matchspec0, 0, actnspec0) # 0 is priority (range may be overlapping)
                for tmpoptype in [PUTREQ_SEQ, PUTREQ_POP_SEQ, PUTREQ_SEQ_CASE3, PUTREQ_POP_SEQ_CASE3]:
                    matchspec0 = distfarreachlimitleaf_update_pktlen_tbl_match_spec_t(\
                            ...
                            vallen_hdr_vallen_start=vallen_start,
                            vallen_hdr_vallen_end=vallen_end) # [vallen_start, vallen_end]
                    actnspec0 = distfarreachlimitleaf_update_pktlen_action_spec_t(val_seq_udplen, val_seq_iplen)
                    self.client.update_pktlen_tbl_table_add_with_update_pktlen(\
                            self.sess_hdl, self.dev_tgt, matchspec0, 0, actnspec0) # 0 is priority (range may be overlapping)
                matchspec0 = distfarreachlimitleaf_update_pktlen_tbl_match_spec_t(\
                        ...
                        vallen_hdr_vallen_start=vallen_start,
                        vallen_hdr_vallen_end=vallen_end) # [vallen_start, vallen_end]
                actnspec0 = distfarreachlimitleaf_update_pktlen_action_spec_t(val_seq_stat_udplen, val_seq_stat_iplen)
                self.client.update_pktlen_tbl_table_add_with_update_pktlen(\
                        self.sess_hdl, self.dev_tgt, matchspec0, 0, actnspec0) # 0 is priority (range may be overlapping)
                matchspec0 = distfarreachlimitleaf_update_pktlen_tbl_match_spec_t(\
                        ...
                        vallen_hdr_vallen_start=vallen_start,
                        vallen_hdr_vallen_end=vallen_end) # [vallen_start, vallen_end]
                actnspec0 = distfarreachlimitleaf_update_pktlen_action_spec_t(val_seq_inswitch_stat_udplen, val_seq_inswitch_stat_iplen)
                self.client.update_pktlen_tbl_table_add_with_update_pktlen(\
                        self.sess_hdl, self.dev_tgt, matchspec0, 0, actnspec0) # 0 is priority (range may be overlapping)
            onlyop_udplen = 28
            onlyop_iplen = 48
            ...
            actnspec0 = distfarreachlimitleaf_update_pktlen_action_spec_t(onlyop_udplen, onlyop_iplen)
            self.client.update_pktlen_tbl_table_add_with_update_pktlen(\
                    self.sess_hdl, self.dev_tgt, matchspec0, 0, actnspec0) # 0 is priority (range may be overlapping)
            for tmpoptype in [PUTRES, DELRES]:
                matchspec0 = distfarreachlimitleaf_update_pktlen_tbl_match_spec_t(\
                        ...
                        vallen_hdr_vallen_start=0,
                        vallen_hdr_vallen_end=switch_max_vallen) # [0, 128]
                actnspec0 = distfarreachlimitleaf_update_pktlen_action_spec_t(stat_udplen, stat_iplen)
                self.client.update_pktlen_tbl_table_add_with_update_pktlen(\
                        self.sess_hdl, self.dev_tgt, matchspec0, 0, actnspec0) # 0 is priority (range may be overlapping)
            for tmpoptype in [DELREQ_SEQ, DELREQ_SEQ_CASE3]:
                matchspec0 = distfarreachlimitleaf_update_pktlen_tbl_match_spec_t(\
                        ...
                        vallen_hdr_vallen_start=0,
                        vallen_hdr_vallen_end=switch_max_vallen) # [0, 128]
                actnspec0 = distfarreachlimitleaf_update_pktlen_action_spec_t(seq_udplen, seq_iplen)
                self.client.update_pktlen_tbl_table_add_with_update_pktlen(\
                        self.sess_hdl, self.dev_tgt, matchspec0, 0, actnspec0) # 0 is priority (range may be overlapping)
            matchspec0 = distfarreachlimitleaf_update_pktlen_tbl_match_spec_t(\
                    op_hdr_optype=SCANREQ_SPLIT,
                    vallen_hdr_vallen_start=0,
                    vallen_hdr_vallen_end=switch_max_vallen) # [0, 128]
            actnspec0 = distfarreachlimitleaf_update_pktlen_action_spec_t(scanreqsplit_udplen, scanreqsplit_iplen)
            self.client.update_pktlen_tbl_table_add_with_update_pktlen(\
                    self.sess_hdl, self.dev_tgt, matchspec0, 0, actnspec0) # 0 is priority (range may be overlapping)
            matchspec0 = distfarreachlimitleaf_update_pktlen_tbl_match_spec_t(\
                    ...
                    vallen_hdr_vallen_start=0,
                    vallen_hdr_vallen_end=switch_max_vallen) # [0, 128]
            actnspec0 = distfarreachlimitleaf_update_pktlen_action_spec_t(frequency_udplen, frequency_iplen)
            self.client.update_pktlen_tbl_table_add_with_update_pktlen(\
                    self.sess_hdl, self.dev_tgt, matchspec0, 0, actnspec0) # 0 is priority (range may be overlapping)
            matchspec0 = distfarreachlimitleaf_update_pktlen_tbl_match_spec_t(\
            ...
            for tmp_client_physical_idx in range(client_physical_num):
                ...
                actnspec0 = distfarreachlimitleaf_update_srcipmac_srcport_server2client_action_spec_t(\
                ...
                for tmpoptype in [GETRES, PUTRES, DELRES, SCANRES_SPLIT, WARMUPACK, LOADACK]:
                    matchspec0 = distfarreachlimitleaf_update_ipmac_srcport_tbl_match_spec_t(\
                            op_hdr_optype = convert_u16_to_i16(tmpoptype), 
            ...
            for tmp_server_physical_idx in range(server_physical_num):
                ...
                actnspec1 = distfarreachlimitleaf_update_dstipmac_client2server_action_spec_t(\
                        macAddr_to_string(tmp_server_mac), \
                        ipv4Addr_to_i32(tmp_server_ip))
            ...
            actnspec2 = distfarreachlimitleaf_update_ipmac_srcport_switch2switchos_action_spec_t(\
            ...
            for tmpoptype in [PUTREQ, PUTREQ_SEQ, PUTREQ_POP_SEQ, PUTREQ_SEQ_CASE3, PUTREQ_POP_SEQ_CASE3, GETRES_LATEST_SEQ_INSWITCH_CASE1, GETRES_DELETED_SEQ_INSWITCH_CASE1, PUTREQ_SEQ_INSWITCH_CASE1, DELREQ_SEQ_INSWITCH_CASE1, GETRES, LOADREQ, CACHE_EVICT_LOADDATA_INSWITCH_ACK, LOADSNAPSHOTDATA_INSWITCH_ACK, GETRES_LATEST_SEQ, GETRES_DELETED_SEQ, GETRES_LATEST_SEQ_SERVER, GETRES_DELETED_SEQ_SERVER]:
                for i in range(switch_max_vallen/8 + 1): # i from 0 to 16
                    if i == 0:
                        ...
                        vallen_start = (i-1)*8+1 # 1, 9, ..., 121
                        vallen_end = (i-1)*8+8 # 8, 16, ..., 128
                    matchspec0 = distfarreachlimitleaf_add_and_remove_value_header_tbl_match_spec_t(\
                            op_hdr_optype=tmpoptype,
                            vallen_hdr_vallen_start=vallen_start,
                            vallen_hdr_vallen_end=vallen_end) # [vallen_start, vallen_end]
                    if i == 0:
            ...
            matchspec0 = distfarreachlimitleaf_drop_tbl_match_spec_t(\
                    op_hdr_optype = GETRES_LATEST_SEQ_INSWITCH)
                                    ...
                                    for snapshot_flag in snapshot_flag_list:
                                        for is_case1 in case1_list:
                                            ...
                                            if is_cached == 0 and is_hot == 0 and validvalue == 0 and is_latest == 0 and is_deleted == 0 and tmp_client_sid == 0 and is_lastclone_for_pktloss == 0 and snapshot_flag == 0 and is_case1 == 0:
                                                matchspec0 = distfarreachlimitleaf_another_eg_port_forward_tbl_match_spec_t(\
                                                    op_hdr_optype = GETRES_LATEST_SEQ_SERVER,
                                                    inswitch_hdr_is_cached = is_cached,
                                                    meta_is_hot = is_hot,
                                                    validvalue_hdr_validvalue = validvalue,
                                                ...
                                                self.client.another_eg_port_forward_tbl_table_add_with_update_getres_latest_seq_server_to_getres(\
                                                        self.sess_hdl, self.dev_tgt, matchspec0)
                                            # size: 4
                                            ...
                                            if is_hot == 0 and validvalue == 0 and is_latest == 0 and is_deleted == 0 and tmp_client_sid == 0 and is_lastclone_for_pktloss == 0 and is_case1 == 0:
                                                ...
                                                self.client.another_eg_port_forward_tbl_table_add_with_update_getres_latest_seq_server_inswitch_to_getres(\
                                                        self.sess_hdl, self.dev_tgt, matchspec0)
                                            ...
                                            if is_hot == 0 and tmp_client_sid == 0 and is_lastclone_for_pktloss == 0:
                                                ...
                                                if is_cached == 1 and validvalue == 1 and is_latest == 0 and snapshot_flag == 1 and is_case1 == 0:
                                                    ...
                                                    if is_deleted == 0: # is_deleted=0 -> stat=1
                                                        #actnspec0 = distfarreachlimitleaf_update_getres_latest_seq_inswitch_to_getres_latest_seq_inswitch_case1_clone_for_pktloss_action_spec_t(self.reflector_sid, self.devPorts[1], 1)
                                                        actnspec0 = distfarreachlimitleaf_update_getres_latest_seq_inswitch_to_getres_latest_seq_inswitch_case1_clone_for_pktloss_action_spec_t(self.reflector_sid, 1, reflector_dp2cpserver_port)
                                                    elif is_deleted == 1: # is_deleted=1 -> stat=0
                                                        #actnspec0 = distfarreachlimitleaf_update_getres_latest_seq_inswitch_to_getres_latest_seq_inswitch_case1_clone_for_pktloss_action_spec_t(self.reflector_sid, self.devPorts[1], 0)
                                                        actnspec0 = distfarreachlimitleaf_update_getres_latest_seq_inswitch_to_getres_latest_seq_inswitch_case1_clone_for_pktloss_action_spec_t(self.reflector_sid, 0, reflector_dp2cpserver_port)
                                                    self.client.another_eg_port_forward_tbl_table_add_with_update_getres_latest_seq_inswitch_to_getres_latest_seq_inswitch_case1_clone_for_pktloss(self.sess_hdl, self.dev_tgt, matchspec0, actnspec0)
                                                elif is_cached == 0:
                                                    # Update GETRES_LATEST_SEQ_INSWITCH as GETRES_LATEST_SEQ to spine (NOT dropped by drop_tbl)
                                                    self.client.another_eg_port_forward_tbl_table_add_with_update_getres_latest_seq_inswitch_to_getres_latest_seq(self.sess_hdl, self.dev_tgt, matchspec0)
                                                # Keep GETERS_LATEST_SEQ_INSWITCH unchanged, and resort to drop_tbl to drop it
                                                #else:
                                                #    # Drop GETRES_LATEST_SEQ_INSWITCH
                                                #    self.client.another_eg_port_forward_tbl_table_add_with_drop_getres_latest_seq_inswitch(\
                                                #            self.sess_hdl, self.dev_tgt, matchspec0)
                                            ...
                                            if is_cached == 1 and snapshot_flag == 1 and is_hot == 0 and validvalue == 0 and is_latest == 0 and is_deleted == 0 and tmp_client_sid == 0 and is_case1 == 0:
                                                ...
                                                if is_lastclone_for_pktloss == 0:
                                                    ...
                                                    actnspec0 = distfarreachlimitleaf_forward_getres_latest_seq_inswitch_case1_clone_for_pktloss_action_spec_t(self.reflector_sid)
                                                    self.client.another_eg_port_forward_tbl_table_add_with_forward_getres_latest_seq_inswitch_case1_clone_for_pktloss(\
                                                            self.sess_hdl, self.dev_tgt, matchspec0, actnspec0)
                                                elif is_lastclone_for_pktloss == 1:
                                                    # Forward GETRES_LATEST_SEQ_INSWITCH_CASE1 (by clone_e2e) to reflector
                                                    #self.client.another_eg_port_forward_tbl_table_add_with_forward_getres_latest_seq_inswitch_case1(\
                                                    #        self.sess_hdl, self.dev_tgt, matchspec0)
                                            ...
                                            if is_cached == 0 and is_hot == 0 and validvalue == 0 and is_latest == 0 and is_deleted == 0 and tmp_client_sid == 0 and is_lastclone_for_pktloss == 0 and snapshot_flag == 0 and is_case1 == 0:
                                                ...
                                                self.client.another_eg_port_forward_tbl_table_add_with_update_getres_deleted_seq_server_to_getres(\
                                                        self.sess_hdl, self.dev_tgt, matchspec0)
                                            # size: 4
                                            ...
                                            if is_hot == 0 and validvalue == 0 and is_latest == 0 and is_deleted == 0 and tmp_client_sid == 0 and is_lastclone_for_pktloss == 0 and is_case1 == 0:
                                                ...
                                                self.client.another_eg_port_forward_tbl_table_add_with_update_getres_deleted_seq_server_inswitch_to_getres(\
                                                        self.sess_hdl, self.dev_tgt, matchspec0)
                                            ...
                                            if is_hot == 0 and tmp_client_sid == 0 and is_lastclone_for_pktloss == 0:
                                                ...
                                                if is_cached == 1 and validvalue == 1 and is_latest == 0 and snapshot_flag == 1 and is_case1 == 0:
                                                    ...
                                                    if is_deleted == 0: # is_deleted=0 -> stat=1
                                                        #actnspec0 = distfarreachlimitleaf_update_getres_deleted_seq_inswitch_to_getres_deleted_seq_inswitch_case1_clone_for_pktloss_action_spec_t(self.reflector_sid, self.devPorts[1], 1)
                                                        actnspec0 = distfarreachlimitleaf_update_getres_deleted_seq_inswitch_to_getres_deleted_seq_inswitch_case1_clone_for_pktloss_action_spec_t(self.reflector_sid, 1, reflector_dp2cpserver_port)
                                                    elif is_deleted == 1: # is_deleted=1 -> stat=0
                                                        #actnspec0 = distfarreachlimitleaf_update_getres_deleted_seq_inswitch_to_getres_deleted_seq_inswitch_case1_clone_for_pktloss_action_spec_t(self.reflector_sid, self.devPorts[1], 0)
                                                        actnspec0 = distfarreachlimitleaf_update_getres_deleted_seq_inswitch_to_getres_deleted_seq_inswitch_case1_clone_for_pktloss_action_spec_t(self.reflector_sid, 0, reflector_dp2cpserver_port)
                                                    self.client.another_eg_port_forward_tbl_table_add_with_update_getres_deleted_seq_inswitch_to_getres_deleted_seq_inswitch_case1_clone_for_pktloss(self.sess_hdl, self.dev_tgt, matchspec0, actnspec0)
                                                elif is_cached == 0:
                                                    # Update GETRES_DELETED_SEQ_INSWITCH as GETRES_DELETED_SEQ to spine (NOT dropped by drop_tbl)
                                                    self.client.another_eg_port_forward_tbl_table_add_with_update_getres_deleted_seq_inswitch_to_getres_deleted_seq(self.sess_hdl, self.dev_tgt, matchspec0)
                                                # Keep GETERS_DELETED_SEQ_INSWITCH unchanged, and resort to drop_tbl to drop it
                                                #else:
                                                #    # Drop GETRES_DELETED_SEQ_INSWITCH
                                                #    self.client.another_eg_port_forward_tbl_table_add_with_drop_getres_deleted_seq_inswitch(\
                                                #            self.sess_hdl, self.dev_tgt, matchspec0)
                                            ...
                                            if is_cached == 1 and snapshot_flag == 1 and is_hot == 0 and validvalue == 0 and is_latest == 0 and is_deleted == 0 and tmp_client_sid == 0 and is_case1 == 0:
                                                ...
                                                if is_lastclone_for_pktloss == 0:
                                                    ...
                                                    actnspec0 = distfarreachlimitleaf_forward_getres_deleted_seq_inswitch_case1_clone_for_pktloss_action_spec_t(self.reflector_sid)
                                                    self.client.another_eg_port_forward_tbl_table_add_with_forward_getres_deleted_seq_inswitch_case1_clone_for_pktloss(\
                                                            self.sess_hdl, self.dev_tgt, matchspec0, actnspec0)
                                                elif is_lastclone_for_pktloss == 1:
                                                    # Forward GETRES_DELETED_SEQ_INSWITCH_CASE1 (by clone_e2e) to reflector
                                                    #self.client.another_eg_port_forward_tbl_table_add_with_forward_getres_deleted_seq_inswitch_case1(\
                                                    #        self.sess_hdl, self.dev_tgt, matchspec0)
                                                    # NOTE: default action is nop -> forward the packet to sid set by clone_e2e
                                                    pass
                                    ...
                                    for snapshot_flag in snapshot_flag_list:
                                        for is_case1 in case1_list:
                                            ...
                                            if is_lastclone_for_pktloss == 0 and snapshot_flag == 0 and is_case1 == 0 and tmp_client_sid != 0:
                                                ...
                                                matchspec0 = distfarreachlimitleaf_eg_port_forward_tbl_match_spec_t(\
                                                    op_hdr_optype = GETREQ_INSWITCH,
                                                    inswitch_hdr_is_cached = is_cached,
                                                    meta_is_hot = is_hot,
                                                    validvalue_hdr_validvalue = validvalue,
                                                ...
                                                if is_cached == 0:
                                                    if is_hot == 1:
                                                        ...
                                                        #actnspec0 = distfarreachlimitleaf_update_getreq_inswitch_to_getreq_pop_action_spec_t(self.devPorts[1])
                                                        ...
                                                        #actnspec0 = distfarreachlimitleaf_update_getreq_inswitch_to_getreq_action_spec_t(self.devPorts[1])
                                                    ...
                                                    if validvalue == 0:
                                                        ...
                                                        if is_latest == 0:
                                                            ...
                                                            #actnspec0 = distfarreachlimitleaf_update_getreq_inswitch_to_getreq_nlatest_action_spec_t(self.devPorts[1])
                                                            ...
                                                            actnspec0 = distfarreachlimitleaf_update_getreq_inswitch_to_getres_by_mirroring_action_spec_t(tmp_client_sid, server_worker_port_start, tmpstat)
                                            ...
                                            if is_cached == 0 and is_hot == 0 and validvalue == 0 and tmp_client_sid == 0 and is_lastclone_for_pktloss == 0 and snapshot_flag == 0 and is_case1 == 0:
                                                ...
                                                actnspec0 = distfarreachlimitleaf_update_cache_pop_inswitch_to_cache_pop_inswitch_ack_drop_and_clone_action_spec_t(self.reflector_sid, reflector_dp2cpserver_port)
                                            ...
                                            if is_cached == 0 and is_hot == 0 and validvalue == 0 and is_latest == 0 and is_deleted == 0 and tmp_client_sid == 0 and snapshot_flag == 0 and is_case1 == 0 and is_lastclone_for_pktloss == 0:
                                                ...
                                                #    actnspec0 = distfarreachlimitleaf_forward_cache_pop_inswitch_ack_clone_for_pktloss_action_spec_t(self.reflector_sid)
                                                ...
                                                if is_cached == 0:
                                                    ...
                                                    if validvalue == 0 or validvalue == 3:
                                                        ...
                                                        if snapshot_flag == 1 and is_case1 == 0:
                                                            ...
                                                            if is_deleted == 0: # is_deleted=0 -> stat=1
                                                                #actnspec0 = distfarreachlimitleaf_update_putreq_seq_inswitch_to_putreq_seq_inswitch_case1_clone_for_pktloss_and_putres_action_spec_t(self.reflector_sid, self.devPorts[1], 1)
                                                                actnspec0 = distfarreachlimitleaf_update_putreq_seq_inswitch_to_putreq_seq_inswitch_case1_clone_for_pktloss_and_putres_action_spec_t(self.reflector_sid, 1, reflector_dp2cpserver_port)
                                                            elif is_deleted == 1: # is_deleted=1 -> stat=0
                                                                #actnspec0 = distfarreachlimitleaf_update_putreq_seq_inswitch_to_putreq_seq_inswitch_case1_clone_for_pktloss_and_putres_action_spec_t(self.reflector_sid, self.devPorts[1], 0)
                                                                actnspec0 = distfarreachlimitleaf_update_putreq_seq_inswitch_to_putreq_seq_inswitch_case1_clone_for_pktloss_and_putres_action_spec_t(self.reflector_sid, 0, reflector_dp2cpserver_port)
                                                            ...
                                                            actnspec0 = distfarreachlimitleaf_update_putreq_seq_inswitch_to_putres_by_mirroring_action_spec_t(tmp_client_sid, server_worker_port_start)
                                            ...
                                            if is_cached == 1 and is_hot == 0 and validvalue == 0 and is_latest == 0 and is_deleted == 0 and snapshot_flag == 1 and is_case1 == 0 and tmp_client_sid != 0:
                                                ...
                                                if is_lastclone_for_pktloss == 0:
                                                    ...
                                                    actnspec0 = distfarreachlimitleaf_forward_putreq_seq_inswitch_case1_clone_for_pktloss_and_putres_action_spec_t(self.reflector_sid)
                                                    ...
                                                    actnspec0 = distfarreachlimitleaf_update_putreq_seq_inswitch_case1_to_putres_by_mirroring_action_spec_t(tmp_client_sid, server_worker_port_start)
                                                ...
                                                if is_cached == 0:
                                                    ...
                                                    if validvalue == 0 or validvalue == 3:
                                                        ...
                                                        if snapshot_flag == 1 and is_case1 == 0:
                                                            ...
                                                            if is_deleted == 0: # is_deleted=0 -> stat=1
                                                                #actnspec0 = distfarreachlimitleaf_update_delreq_seq_inswitch_to_delreq_seq_inswitch_case1_clone_for_pktloss_and_delres_action_spec_t(self.reflector_sid, self.devPorts[1], 1)
                                                                actnspec0 = distfarreachlimitleaf_update_delreq_seq_inswitch_to_delreq_seq_inswitch_case1_clone_for_pktloss_and_delres_action_spec_t(self.reflector_sid, 1, reflector_dp2cpserver_port)
                                                            elif is_deleted == 1: # is_deleted=1 -> stat=0
                                                                #actnspec0 = distfarreachlimitleaf_update_delreq_seq_inswitch_to_delreq_seq_inswitch_case1_clone_for_pktloss_and_delres_action_spec_t(self.reflector_sid, self.devPorts[1], 0)
                                                                actnspec0 = distfarreachlimitleaf_update_delreq_seq_inswitch_to_delreq_seq_inswitch_case1_clone_for_pktloss_and_delres_action_spec_t(self.reflector_sid, 0, reflector_dp2cpserver_port)
                                                            ...
                                                            actnspec0 = distfarreachlimitleaf_update_delreq_seq_inswitch_to_delres_by_mirroring_action_spec_t(tmp_client_sid, server_worker_port_start)
                                            ...
                                            if is_cached == 1 and is_hot == 0 and validvalue == 0 and is_latest == 0 and is_deleted == 0 and snapshot_flag == 1 and is_case1 == 0 and tmp_client_sid != 0:
                                                ...
                                                if is_lastclone_for_pktloss == 0:
                                                    ...
                                                    actnspec0 = distfarreachlimitleaf_forward_delreq_seq_inswitch_case1_clone_for_pktloss_and_delres_action_spec_t(self.reflector_sid)
                                                    ...
                                                    actnspec0 = distfarreachlimitleaf_update_delreq_seq_inswitch_case1_to_delres_by_mirroring_action_spec_t(tmp_client_sid, server_worker_port_start)
                                            ...
                                            if is_cached == 1 and is_hot == 0 and validvalue == 0 and is_latest == 0 and is_deleted == 0 and tmp_client_sid == 0 and is_lastclone_for_pktloss == 0 and snapshot_flag == 0 and is_case1 == 0:
                                                ...
                                                actnspec0 = distfarreachlimitleaf_update_cache_evict_loadfreq_inswitch_to_cache_evict_loadfreq_inswitch_ack_drop_and_clone_action_spec_t(self.reflector_sid, reflector_dp2cpserver_port)
                                            ...
                                            if is_cached == 1 and is_hot == 0 and validvalue == 0 and is_latest == 0 and tmp_client_sid == 0 and is_lastclone_for_pktloss == 0 and snapshot_flag == 0 and is_case1 == 0:
                                                ...
                                                actnspec0 = distfarreachlimitleaf_update_cache_evict_loaddata_inswitch_to_cache_evict_loaddata_inswitch_ack_drop_and_clone_action_spec_t(self.reflector_sid, reflector_dp2cpserver_port, tmpstat)
                                            ...
                                            if is_hot == 0 and validvalue == 0 and is_latest == 0 and tmp_client_sid == 0 and is_lastclone_for_pktloss == 0 and snapshot_flag == 0 and is_case1 == 0:
                                                ...
                                                actnspec0 = distfarreachlimitleaf_update_loadsnapshotdata_inswitch_to_loadsnapshotdata_inswitch_ack_drop_and_clone_action_spec_t(self.reflector_sid, reflector_dp2cpserver_port, tmpstat)
                                            ...
                                            if is_hot == 0 and is_latest == 0 and is_deleted == 0 and tmp_client_sid == 0 and is_lastclone_for_pktloss == 0 and snapshot_flag == 0 and is_case1 == 0:
                                                ...
                                                actnspec0 = distfarreachlimitleaf_update_setvalid_inswitch_to_setvalid_inswitch_ack_drop_and_clone_action_spec_t(self.reflector_sid, reflector_dp2cpserver_port)
                                                ...
                                                for tmp_server_sid in tmp_server_sids:
                                                    ...
                                                    if is_cached == 0 and is_hot == 0 and validvalue == 0 and is_latest == 0 and is_deleted == 0 and tmp_client_sid == 0 and is_lastclone_for_pktloss == 0 and snapshot_flag == 0 and is_case1 == 0 and tmp_server_sid != 0:
                                                        ...
                                                        if is_last_scansplit == 1:
                                                            ...
                                                            actnspec0 = distfarreachlimitleaf_forward_scanreq_split_and_clone_action_spec_t(tmp_server_sid)
