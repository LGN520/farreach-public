...
class RegisterUpdate(pd_base_tests.ThriftInterfaceDataPlane):
    ...
    def runTest(self):
        ...
        print("keylolo_list size: {} keylohi_list size: {}".format(len(keylolo_list), len(keylohi_list)))
        print("keyhilo_list size: {} keyhihi_list size: {}".format(len(keyhilo_list), len(keyhihi_list)))
