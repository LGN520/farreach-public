...
// udp
void create_udpsock(volatile int &sockfd, const char* role = "sockethelper.udpsock");
...
void prepare_udpserver(volatile int &sockfd, bool need_timeout, short server_port, const char* role = "sockethelper.udpserver");
...
// tcp
void create_tcpsock(volatile int &sockfd, const char* role = "sockethelper.tcpsock");
...
void prepare_tcpserver(volatile int &sockfd, bool need_timeout, short server_port, int max_pending_num, const char *role = "sockethelper.tcpserver");
