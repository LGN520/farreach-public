...
public final class GlobalConfig {
  ...
  public static final int DEFAULT_SOCKET_TIMEOUT_SECS = 5;
  public static final int CLIENT_SOCKET_TIMEOUT_SECS = 5;
  public static final int CLIENT_SCAN_SOCKET_TIMEOUT_SECS = 5;
  ...
  public static int getRotatedServeridxForRotation() {
    MyUtils.myAssert(isStaticPattern() && serverPhysicalNum > 1 && serverLogicalIdxesList[1].size() == 1);
