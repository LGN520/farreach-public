...
class TableConfigure:
    ...
    def runTest(self):
        ...
        for tmpoptype in [GETREQ]:
            controller.table_add("sample_tbl", "sample", [hex(tmpoptype)], [])
        ...
        controller.table_add("prepare_for_cachepop_tbl", "NoAction", matchspec0, [])
        ...
        controller.table_add("is_report_tbl", "set_is_report", matchspec0, [])
...
# tableconfig.clean_all_tables()
# print(controller.get_tables())
# for table_name in controller.get_tables():
#     controller.table_clear(table_name)
# print(table_name)
# controller.table_dump(table_name)
