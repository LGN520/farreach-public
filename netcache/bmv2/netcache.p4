...
//blank checksum
control netcacheVerifyChecksum(inout headers hdr, inout metadata meta) {
    apply {  }
}
control netcacheComputeChecksum(inout headers hdr, inout metadata meta) {
    apply { 	 
        update_checksum(
...
V1Switch(
netcacheParser(),
netcacheVerifyChecksum(),
netcacheIngress(),
netcacheEgress(),
netcacheComputeChecksum(),
netcacheDeparser()
) main;