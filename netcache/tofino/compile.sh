...
./configure --prefix=$SDE_INSTALL --with-tofino P4_NAME=netcache P4_PATH=/home/${USER}/${CLIENT_ROOTPATH}/netcache/tofino/netcache.p4  enable_thrift=yes  P4_VERSION=p4-14
make
make install
