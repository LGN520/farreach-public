...
./configure --prefix=$SDE_INSTALL --with-tofino P4_NAME=nocache P4_PATH=/home/${USER}/${SWITCH_ROOTPATH}/nocache/tofino/nocache.p4  enable_thrift=yes  P4_VERSION=p4-14
make
make install
