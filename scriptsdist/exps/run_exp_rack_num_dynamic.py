    ...
    for exp1_rule in exp1_dynamic_rule_list:
        for exp1_physical_server_scale in scale_list:
            ...
            rules = [
                ...
                ('global','workload_mode','1'),
                ('global','dynamic_ruleprefix',exp1_rule),
            ...
            rules = [
                ...
                ('global','workload_mode','1'),
                ('global','dynamic_ruleprefix',exp1_rule),
                ('global','dynamic_periodinterval','180'),
                # ('global','client_physical_num','1'),
                # ('global','client_total_logical_num','2'),
            ]
            ...
            # sleep(10)
            # command_fake0 = f"cd {SERVER_ROOTPATH}/{exp1_method}; mx h1 python fake_cachepop_client.py"
            # subprocess.run(command_fake0, shell=True)
            ...
            if os.path.exists(f"{CLIENT_ROOTPATH}/benchmarkdist/ycsb/tmp_client0.out"):
                shutil.move(f"{CLIENT_ROOTPATH}/benchmarkdist/ycsb/tmp_client0.out",
                            f"{exp1_output_path}/{exp1_workload}-{exp1_method}-static{exp1_server_scale_total}-{exp1_physical_server_scale}-{exp1_rule}-client0.out.txt")
            else:
                print(f"[ERROR]{CLIENT_ROOTPATH}/benchmarkdist/ycsb/tmp_client0.out is not exist check tmp_client.out")
            if os.path.exists(f"{CLIENT_ROOTPATH}/benchmarkdist/output/{exp1_workload}-statistics/{exp1_method_dic[exp1_method]}-{exp1_rule}-client0.out"):  
                shutil.move(f"{CLIENT_ROOTPATH}/benchmarkdist/output/{exp1_workload}-statistics/{exp1_method_dic[exp1_method]}-{exp1_rule}-client0.out",
                            f"{exp1_output_path}/{exp1_workload}-{exp1_method}-{exp1_rule}{exp1_server_scale_total}-{exp1_physical_server_scale}-client0.out")
            else:
                print(f"[ERROR]{CLIENT_ROOTPATH}/benchmarkdist/output/{exp1_workload}-statistics/{exp1_method_dic[exp1_method]}-{exp1_rule}-client0.out is not exist check tmp_client.out")
            ...
            #     shutil.move(f"{CLIENT_ROOTPATH}/benchmarkdist/output/{exp1_workload}-statistics/{exp1_method_dic[exp1_method]}-{exp1_rule}-client0.out",
            #                     f"{exp1_output_path}/{exp1_workload}-{exp1_method}-{exp1_rule}{exp1_server_scale_total}-{exp1_physical_server_scale}-client0.out")
            # # shutil.move(f"{CLIENT_ROOTPATH}/benchmarkdist/output/{exp1_workload}-statistics/{exp1_method_dic[exp1_method]}-static{exp1_server_scale_total}-client1.out",
            # #                 f"{exp1_output_path}/{exp1_workload}-{exp1_method}-static{exp1_server_scale_total}-{exp1_physical_server_scale}-client1.out")
