...
SWITCHOS_WRITEALLSEQ = int(control_config.get("switchos", "SWITCHOS_WRITEALLSEQ"))
...
BACKUP = 0x009f
CACHE_POP_INSWITCH_FORWARD = 0x107f
...
GETRES_SEQ=0x006b
PUTRES_SPINE_SEQ=0xf06b #like getres need value
GETREQ_BEINGEVICTED_RECORD = 0x007b
GETREQ_LARGEVALUEBLOCK_RECORD = 0x008b
# 0b1001
GETRES = 0x0009
# 0b0101
...
SETVALID_INSWITCH_FORWARD = 0x1054
...
GETREQ_LARGEVALUEBLOCK_SEQ = 0x00e2
# 0b1000
PUTRES = 0x0008
DELRES = 0x0018
# 0b1010
