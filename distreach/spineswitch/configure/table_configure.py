...
class TableConfigure:
    ...
    def configure_recover_tbl(self):
        for is_cached, isfound in product(found_list, cached_list):
            if (is_cached, isfound) == (1, 0):
                matchspec0 = [hex(BACKUPACK), hex(is_cached), hex(isfound)]
                self.controller.table_add(
                    "recover_tbl",
                    "get_backup",
                    matchspec0,
                )
                matchspec0 = [hex(BACKUP), hex(is_cached), hex(isfound)]
                self.controller.table_add(
                    "recover_tbl",
                    "get_backup",
                    matchspec0,
    ...
    def runTest(self):
        ...
        self.controller.table_add(
            "special_ig_port_forward_tbl", "forward_backup", matchspec0, actnspec0
        )
        # Egress pipeline
        ...
        for tmpoptype in [
            ...
            matchspec0 = [hex(tmpoptype), hex(1)]
            self.controller.table_add(
                "access_validvalue_tbl", "get_validvalue", matchspec0
            )
        for is_cached in cached_list:
                                    ...
                                    for snapshot_flag in snapshot_flag_list:
                                        for is_case1 in case1_list:
                                                ...
                                                if is_cached == 0:
                                                    ...
                                                    if validvalue == 0:
                                                        ...
                                                        if is_latest == 0:
                                                            ...
                                                            # self.controller.table_add('eg_port_forward_tbl','update_getreq_inswitch_to_getreq_beingevicted',matchspec0)
                                            ...
                                            if (
                                                ...
                                                #    self.controller.table_add('another_eg_port_forward_tbl','drop_getres_latest_seq_inswitch',matchspec0)
                                            ...
                                            if (
                                                ...
                                                if is_lastclone_for_pktloss == 0:
                                                    ...
                                                    # self.controller.table_add('another_eg_port_forward_tbl','forward_getres_latest_seq_inswitch_case1',matchspec0)
                                            ...
                                            if (
                                                ...
                                                #    self.controller.table_add('another_eg_port_forward_tbl','drop_getres_deleted_seq_inswitch',matchspec0)
                                            ...
                                            if (
                                                ...
                                                if is_lastclone_for_pktloss == 0:
                                                    ...
                                                    # self.controller.table_add('another_eg_port_forward_tbl','forward_getres_deleted_seq_inswitch_case1',matchspec0)
                                                    # NOTE: default action is NoAction	 -> forward the packet to sid set by clone_e2e
                                                    pass
                                                        ...
                                                        if validvalue == 0:
                                                            ...
                                                            if is_latest == 0:
                                                                if (
                                                                    ...
                                                                    # self.controller.table_add('another_eg_port_forward_tbl','update_getreq_inswitch_to_getreq_largevalueblock_seq',matchspec0)
                                                            ...
                                                            if is_latest == 0:
                                                                ## Update GETREQ_INSWITCH as GETREQ_BEINGEVICTED to server
                                                                # self.controller.table_add('another_eg_port_forward_tbl','update_getreq_inswitch_to_getreq_beingevicted',matchspec0)
                                                                # Update GETREQ_INSWITCH as GETREQ_BEINGEVICTED_RECORD to server
                                                                actnspec0 = [
                                                                    hex(tmpstat)
                                                                ]
    ...
    def configure_update_pktlen_tbl(self):
        for i in range(int(int(switch_max_vallen / 8 + 1))):  # i from 0 to 16
            ...
            for tmpoptype in [
                ...
                actnspec0 = [
                    hex(shadowtype_seq_udp_delta),
                    hex(shadowtype_seq_ip_delta),
                ]
                self.controller.table_add(
