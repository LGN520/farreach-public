#ifndef YCSB_PARSER_H
#define YCSB_PARSER_H
...
class YcsbParserIterator : public ParserIterator {
	public:
		YcsbParserIterator(const char* filename);
		YcsbParserIterator(const YcsbParserIterator& other);
		virtual ~YcsbParserIterator();
