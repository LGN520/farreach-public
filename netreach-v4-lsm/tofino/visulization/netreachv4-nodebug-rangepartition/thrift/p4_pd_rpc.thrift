...
struct netbufferv4_process_scanreq_split_tbl_match_spec_t {
  1: required i16 op_hdr_optype;
  2: required i16 split_hdr_globalserveridx;
...
struct netbufferv4_process_cloned_scanreq_split_action_spec_t {
  ...
  2: required i16 action_server_sid;
}

struct netbufferv4_range_partition_for_scan_endkey_action_spec_t {
  1: required i16 action_end_globalserveridx_plus_one;
}
...
struct netbufferv4_range_partition_for_scan_action_spec_t {
  1: required i16 action_udpport;
  2: required i16 action_eport;
...
union netbufferv4_action_specs_t {
  ...
  25: netbufferv4_process_scanreq_split_action_spec_t netbufferv4_process_scanreq_split;
  26: netbufferv4_process_cloned_scanreq_split_action_spec_t netbufferv4_process_cloned_scanreq_split;
