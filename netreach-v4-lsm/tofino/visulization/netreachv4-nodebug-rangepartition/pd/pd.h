...
typedef struct p4_pd_netbufferv4_process_scanreq_split_tbl_match_spec {
  uint16_t op_hdr_optype;
  uint16_t split_hdr_globalserveridx;
...
typedef struct p4_pd_netbufferv4_range_partition_for_scan_endkey_action_spec {
  uint16_t action_end_globalserveridx_plus_one;
...
typedef struct p4_pd_netbufferv4_range_partition_for_scan_action_spec {
  uint16_t action_udpport;
  uint16_t action_eport;
...
/**
 * @brief p4_pd_netbufferv4_range_partition_tbl_table_add_with_range_partition_for_scan
 * @param sess_hdl
 * @param dev_tgt
 * @param match_spec
 * @param priority
...
*/
p4_pd_status_t
p4_pd_netbufferv4_range_partition_tbl_table_add_with_range_partition_for_scan
(
 p4_pd_sess_hdl_t sess_hdl,
 p4_pd_dev_target_t dev_tgt,
 p4_pd_netbufferv4_range_partition_tbl_match_spec_t *match_spec,
...
/**
 * @brief p4_pd_netbufferv4_range_partition_tbl_table_modify_with_range_partition_for_scan
 * @param sess_hdl
 * @param dev_id
 * @param entry_hdl
 * @param action_spec
*/
p4_pd_status_t
p4_pd_netbufferv4_range_partition_tbl_table_modify_with_range_partition_for_scan
(
 p4_pd_sess_hdl_t sess_hdl,
 uint8_t dev_id,
 p4_pd_entry_hdl_t ent_hdl,
...
/**
 * @brief p4_pd_netbufferv4_range_partition_tbl_table_modify_with_range_partition_for_scan_by_match_spec
 * @param sess_hdl
 * @param dev_tgt
 * @param match_spec
 * @param priority
...
*/
p4_pd_status_t
p4_pd_netbufferv4_range_partition_tbl_table_modify_with_range_partition_for_scan_by_match_spec
(
 p4_pd_sess_hdl_t sess_hdl,
 p4_pd_dev_target_t dev_tgt,
 p4_pd_netbufferv4_range_partition_tbl_match_spec_t *match_spec,
