...
struct netbufferv4_eg_port_forward_tbl_match_spec_t {
  ...
  11: required byte meta_is_last_scansplit;
  12: required i16 meta_server_sid;
}
...
struct netbufferv4_process_scanreq_split_tbl_match_spec_t {
  1: required i16 op_hdr_optype;
  2: required i16 udp_hdr_dstPort;
  3: required byte split_hdr_is_clone;
}

struct netbufferv4_range_partition_for_scan_endkey_tbl_match_spec_t {
  1: required i16 op_hdr_optype;
  2: required i16 scan_hdr_keyhihihi_start;
  3: required i16 scan_hdr_keyhihihi_end;
  4: required byte meta_need_recirculate;
}

struct netbufferv4_range_partition_tbl_match_spec_t {
  1: required i16 op_hdr_optype;
  2: required i16 op_hdr_keyhihihi_start;
  3: required i16 op_hdr_keyhihihi_end;
  4: required byte meta_need_recirculate;
}
...
struct netbufferv4_forward_scanreq_split_and_clone_action_spec_t {
  1: required i32 action_server_sid;
}
...
struct netbufferv4_process_scanreq_split_action_spec_t {
  1: required i16 action_server_sid;
}

struct netbufferv4_process_cloned_scanreq_split_action_spec_t {
  1: required i16 action_server_sid;
}

struct netbufferv4_range_partition_for_scan_endkey_action_spec_t {
  1: required i16 action_last_udpport_plus_one;
}

struct netbufferv4_range_partition_action_spec_t {
...
union netbufferv4_action_specs_t {
  ...
  16: netbufferv4_forward_scanreq_split_and_clone_action_spec_t netbufferv4_forward_scanreq_split_and_clone;
  17: netbufferv4_update_cache_evict_loadfreq_inswitch_to_cache_evict_loadfreq_inswitch_ack_drop_and_clone_action_spec_t netbufferv4_update_cache_evict_loadfreq_inswitch_to_cache_evict_loadfreq_inswitch_ack_drop_and_clone;
  18: netbufferv4_update_cache_evict_loaddata_inswitch_to_cache_evict_loaddata_inswitch_ack_drop_and_clone_action_spec_t netbufferv4_update_cache_evict_loaddata_inswitch_to_cache_evict_loaddata_inswitch_ack_drop_and_clone;
  19: netbufferv4_update_loadsnapshotdata_inswitch_to_loadsnapshotdata_inswitch_ack_drop_and_clone_action_spec_t netbufferv4_update_loadsnapshotdata_inswitch_to_loadsnapshotdata_inswitch_ack_drop_and_clone;
  20: netbufferv4_update_setvalid_inswitch_to_setvalid_inswitch_ack_drop_and_clone_action_spec_t netbufferv4_update_setvalid_inswitch_to_setvalid_inswitch_ack_drop_and_clone;
  ...
  24: netbufferv4_process_scanreq_split_action_spec_t netbufferv4_process_scanreq_split;
  25: netbufferv4_process_cloned_scanreq_split_action_spec_t netbufferv4_process_cloned_scanreq_split;
  26: netbufferv4_range_partition_for_scan_endkey_action_spec_t netbufferv4_range_partition_for_scan_endkey;
  27: netbufferv4_range_partition_action_spec_t netbufferv4_range_partition;
  28: netbufferv4_recirculate_pkt_action_spec_t netbufferv4_recirculate_pkt;
  29: netbufferv4_set_hot_threshold_action_spec_t netbufferv4_set_hot_threshold;
  30: netbufferv4_update_ipmac_srcport_server2client_action_spec_t netbufferv4_update_ipmac_srcport_server2client;
  31: netbufferv4_update_ipmac_srcport_switch2switchos_action_spec_t netbufferv4_update_ipmac_srcport_switch2switchos;
  32: netbufferv4_update_dstipmac_client2server_action_spec_t netbufferv4_update_dstipmac_client2server;
  33: netbufferv4_update_pktlen_action_spec_t netbufferv4_update_pktlen;
}
...
struct netbufferv4_process_scanreq_split_tbl_entry_desc_t {
  1: required netbufferv4_process_scanreq_split_tbl_match_spec_t match_spec;
  2: required bool has_mbr_hdl;
  3: required bool has_grp_hdl;
  4: required MemberHandle_t selector_grp_hdl;
  5: required MemberHandle_t action_mbr_hdl;
...
struct netbufferv4_range_partition_for_scan_endkey_tbl_entry_desc_t {
  1: required netbufferv4_range_partition_for_scan_endkey_tbl_match_spec_t match_spec;
  2: required bool has_mbr_hdl;
  3: required bool has_grp_hdl;
  4: required MemberHandle_t selector_grp_hdl;
  5: required MemberHandle_t action_mbr_hdl;
...
struct netbufferv4_range_partition_tbl_entry_desc_t {
  1: required netbufferv4_range_partition_tbl_match_spec_t match_spec;
  2: required bool has_mbr_hdl;
  3: required bool has_grp_hdl;
  4: required MemberHandle_t selector_grp_hdl;
  5: required MemberHandle_t action_mbr_hdl;
...
service netbufferv4 {
    ...
    EntryHandle_t process_scanreq_split_tbl_match_spec_to_entry_hdl(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:netbufferv4_process_scanreq_split_tbl_match_spec_t match_spec) throws (1:InvalidTableOperation ouch),
    EntryHandle_t range_partition_for_scan_endkey_tbl_match_spec_to_entry_hdl(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:netbufferv4_range_partition_for_scan_endkey_tbl_match_spec_t match_spec, 4:i32 priority) throws (1:InvalidTableOperation ouch),
    EntryHandle_t range_partition_tbl_match_spec_to_entry_hdl(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:netbufferv4_range_partition_tbl_match_spec_t match_spec, 4:i32 priority) throws (1:InvalidTableOperation ouch),
    ...
    EntryHandle_t eg_port_forward_tbl_table_add_with_forward_scanreq_split_and_clone(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:netbufferv4_eg_port_forward_tbl_match_spec_t match_spec, 4:netbufferv4_forward_scanreq_split_and_clone_action_spec_t action_spec) throws (1:InvalidTableOperation ouch),
    EntryHandle_t eg_port_forward_tbl_table_add_with_forward_scanreq_split(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:netbufferv4_eg_port_forward_tbl_match_spec_t match_spec) throws (1:InvalidTableOperation ouch),
    ...
    EntryHandle_t ig_port_forward_tbl_table_add_with_update_scanreq_to_scanreq_split(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:netbufferv4_ig_port_forward_tbl_match_spec_t match_spec) throws (1:InvalidTableOperation ouch),
    ...
    EntryHandle_t lastclone_lastscansplit_tbl_table_add_with_set_is_lastscansplit(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:netbufferv4_lastclone_lastscansplit_tbl_match_spec_t match_spec) throws (1:InvalidTableOperation ouch),
    ...
    EntryHandle_t process_scanreq_split_tbl_table_add_with_process_scanreq_split(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:netbufferv4_process_scanreq_split_tbl_match_spec_t match_spec, 4:netbufferv4_process_scanreq_split_action_spec_t action_spec) throws (1:InvalidTableOperation ouch),
    EntryHandle_t process_scanreq_split_tbl_table_add_with_process_cloned_scanreq_split(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:netbufferv4_process_scanreq_split_tbl_match_spec_t match_spec, 4:netbufferv4_process_cloned_scanreq_split_action_spec_t action_spec) throws (1:InvalidTableOperation ouch),
    EntryHandle_t process_scanreq_split_tbl_table_add_with_reset_meta_serversid_remainscannum(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:netbufferv4_process_scanreq_split_tbl_match_spec_t match_spec) throws (1:InvalidTableOperation ouch),
    EntryHandle_t range_partition_for_scan_endkey_tbl_table_add_with_range_partition_for_scan_endkey(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:netbufferv4_range_partition_for_scan_endkey_tbl_match_spec_t match_spec, 4:i32 priority, 5:netbufferv4_range_partition_for_scan_endkey_action_spec_t action_spec) throws (1:InvalidTableOperation ouch),
    ...
    void eg_port_forward_tbl_table_modify_with_forward_scanreq_split_and_clone(1:res.SessionHandle_t sess_hdl, 2:byte dev_id, 3:EntryHandle_t entry, 4:netbufferv4_forward_scanreq_split_and_clone_action_spec_t action_spec) throws (1:InvalidTableOperation ouch),
    void eg_port_forward_tbl_table_modify_with_forward_scanreq_split_and_clone_by_match_spec(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:netbufferv4_eg_port_forward_tbl_match_spec_t match_spec, 4:netbufferv4_forward_scanreq_split_and_clone_action_spec_t action_spec) throws (1:InvalidTableOperation ouch),
    void eg_port_forward_tbl_table_modify_with_forward_scanreq_split(1:res.SessionHandle_t sess_hdl, 2:byte dev_id, 3:EntryHandle_t entry) throws (1:InvalidTableOperation ouch),
    void eg_port_forward_tbl_table_modify_with_forward_scanreq_split_by_match_spec(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:netbufferv4_eg_port_forward_tbl_match_spec_t match_spec) throws (1:InvalidTableOperation ouch),
    ...
    void ig_port_forward_tbl_table_modify_with_update_scanreq_to_scanreq_split(1:res.SessionHandle_t sess_hdl, 2:byte dev_id, 3:EntryHandle_t entry) throws (1:InvalidTableOperation ouch),
    void ig_port_forward_tbl_table_modify_with_update_scanreq_to_scanreq_split_by_match_spec(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:netbufferv4_ig_port_forward_tbl_match_spec_t match_spec) throws (1:InvalidTableOperation ouch),
    ...
    void lastclone_lastscansplit_tbl_table_modify_with_set_is_lastscansplit(1:res.SessionHandle_t sess_hdl, 2:byte dev_id, 3:EntryHandle_t entry) throws (1:InvalidTableOperation ouch),
    void lastclone_lastscansplit_tbl_table_modify_with_set_is_lastscansplit_by_match_spec(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:netbufferv4_lastclone_lastscansplit_tbl_match_spec_t match_spec) throws (1:InvalidTableOperation ouch),
    ...
    void process_scanreq_split_tbl_table_modify_with_process_scanreq_split(1:res.SessionHandle_t sess_hdl, 2:byte dev_id, 3:EntryHandle_t entry, 4:netbufferv4_process_scanreq_split_action_spec_t action_spec) throws (1:InvalidTableOperation ouch),
    void process_scanreq_split_tbl_table_modify_with_process_scanreq_split_by_match_spec(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:netbufferv4_process_scanreq_split_tbl_match_spec_t match_spec, 4:netbufferv4_process_scanreq_split_action_spec_t action_spec) throws (1:InvalidTableOperation ouch),
    void process_scanreq_split_tbl_table_modify_with_process_cloned_scanreq_split(1:res.SessionHandle_t sess_hdl, 2:byte dev_id, 3:EntryHandle_t entry, 4:netbufferv4_process_cloned_scanreq_split_action_spec_t action_spec) throws (1:InvalidTableOperation ouch),
    void process_scanreq_split_tbl_table_modify_with_process_cloned_scanreq_split_by_match_spec(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:netbufferv4_process_scanreq_split_tbl_match_spec_t match_spec, 4:netbufferv4_process_cloned_scanreq_split_action_spec_t action_spec) throws (1:InvalidTableOperation ouch),
    void process_scanreq_split_tbl_table_modify_with_reset_meta_serversid_remainscannum(1:res.SessionHandle_t sess_hdl, 2:byte dev_id, 3:EntryHandle_t entry) throws (1:InvalidTableOperation ouch),
    void process_scanreq_split_tbl_table_modify_with_reset_meta_serversid_remainscannum_by_match_spec(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:netbufferv4_process_scanreq_split_tbl_match_spec_t match_spec) throws (1:InvalidTableOperation ouch),
    void range_partition_for_scan_endkey_tbl_table_modify_with_range_partition_for_scan_endkey(1:res.SessionHandle_t sess_hdl, 2:byte dev_id, 3:EntryHandle_t entry, 4:netbufferv4_range_partition_for_scan_endkey_action_spec_t action_spec) throws (1:InvalidTableOperation ouch),
    void range_partition_for_scan_endkey_tbl_table_modify_with_range_partition_for_scan_endkey_by_match_spec(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:netbufferv4_range_partition_for_scan_endkey_tbl_match_spec_t match_spec, 4:i32 priority, 5:netbufferv4_range_partition_for_scan_endkey_action_spec_t action_spec) throws (1:InvalidTableOperation ouch),
    void range_partition_for_scan_endkey_tbl_table_modify_with_nop(1:res.SessionHandle_t sess_hdl, 2:byte dev_id, 3:EntryHandle_t entry) throws (1:InvalidTableOperation ouch),
    void range_partition_for_scan_endkey_tbl_table_modify_with_nop_by_match_spec(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:netbufferv4_range_partition_for_scan_endkey_tbl_match_spec_t match_spec, 4:i32 priority) throws (1:InvalidTableOperation ouch),
    void range_partition_tbl_table_modify_with_range_partition(1:res.SessionHandle_t sess_hdl, 2:byte dev_id, 3:EntryHandle_t entry, 4:netbufferv4_range_partition_action_spec_t action_spec) throws (1:InvalidTableOperation ouch),
...
# //::   if action_table_hdl: continue
    void process_scanreq_split_tbl_table_delete(1:res.SessionHandle_t sess_hdl, 2:byte dev_id, 3:EntryHandle_t entry) throws (1:InvalidTableOperation ouch),
    void process_scanreq_split_tbl_table_delete_by_match_spec(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:netbufferv4_process_scanreq_split_tbl_match_spec_t match_spec) throws (1:InvalidTableOperation ouch),
# //::   if action_table_hdl: continue
    void range_partition_for_scan_endkey_tbl_table_delete(1:res.SessionHandle_t sess_hdl, 2:byte dev_id, 3:EntryHandle_t entry) throws (1:InvalidTableOperation ouch),
    void range_partition_for_scan_endkey_tbl_table_delete_by_match_spec(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:netbufferv4_range_partition_for_scan_endkey_tbl_match_spec_t match_spec, 4:i32 priority) throws (1:InvalidTableOperation ouch),
# //::   if action_table_hdl: continue
    void range_partition_tbl_table_delete(1:res.SessionHandle_t sess_hdl, 2:byte dev_id, 3:EntryHandle_t entry) throws (1:InvalidTableOperation ouch),
    void range_partition_tbl_table_delete_by_match_spec(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:netbufferv4_range_partition_tbl_match_spec_t match_spec, 4:i32 priority) throws (1:InvalidTableOperation ouch),
# //::   if action_table_hdl: continue
...
# //::   if action_table_hdl: continue
    ...
    EntryHandle_t process_scanreq_split_tbl_table_get_default_entry_handle(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt) throws (1:InvalidTableOperation ouch),
    netbufferv4_process_scanreq_split_tbl_entry_desc_t process_scanreq_split_tbl_table_get_default_entry(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:bool read_from_hw) throws (1:InvalidTableOperation ouch),
    EntryHandle_t range_partition_for_scan_endkey_tbl_table_get_default_entry_handle(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt) throws (1:InvalidTableOperation ouch),
    netbufferv4_range_partition_for_scan_endkey_tbl_entry_desc_t range_partition_for_scan_endkey_tbl_table_get_default_entry(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:bool read_from_hw) throws (1:InvalidTableOperation ouch),
    EntryHandle_t range_partition_tbl_table_get_default_entry_handle(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt) throws (1:InvalidTableOperation ouch),
    netbufferv4_range_partition_tbl_entry_desc_t range_partition_tbl_table_get_default_entry(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:bool read_from_hw) throws (1:InvalidTableOperation ouch),
...
# //::   if action_table_hdl: continue
    void process_scanreq_split_tbl_table_reset_default_entry(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt) throws (1:InvalidTableOperation ouch),
# //::   if action_table_hdl: continue
    void range_partition_for_scan_endkey_tbl_table_reset_default_entry(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt) throws (1:InvalidTableOperation ouch),
# //::   if action_table_hdl: continue
    void range_partition_tbl_table_reset_default_entry(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt) throws (1:InvalidTableOperation ouch),
# //::   if action_table_hdl: continue
...
# //::   if action_table_hdl: continue
    ...
    i32 process_scanreq_split_tbl_get_entry_count(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt) throws (1:InvalidTableOperation ouch),
    i32 range_partition_for_scan_endkey_tbl_get_entry_count(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt) throws (1:InvalidTableOperation ouch),
    i32 range_partition_tbl_get_entry_count(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt) throws (1:InvalidTableOperation ouch),
    ...
    i32 process_scanreq_split_tbl_get_first_entry_handle(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt) throws (1:InvalidTableOperation ouch),

    list<i32> process_scanreq_split_tbl_get_next_entry_handles(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:EntryHandle_t entry_hdl, 4:i32 n) throws (1:InvalidTableOperation ouch),

    netbufferv4_process_scanreq_split_tbl_entry_desc_t process_scanreq_split_tbl_get_entry(1:res.SessionHandle_t sess_hdl, 2:byte dev_id, 3:EntryHandle_t entry_hdl, 4:bool read_from_hw) throws (1:InvalidTableOperation ouch),

    i32 range_partition_for_scan_endkey_tbl_get_first_entry_handle(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt) throws (1:InvalidTableOperation ouch),

    list<i32> range_partition_for_scan_endkey_tbl_get_next_entry_handles(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:EntryHandle_t entry_hdl, 4:i32 n) throws (1:InvalidTableOperation ouch),

    netbufferv4_range_partition_for_scan_endkey_tbl_entry_desc_t range_partition_for_scan_endkey_tbl_get_entry(1:res.SessionHandle_t sess_hdl, 2:byte dev_id, 3:EntryHandle_t entry_hdl, 4:bool read_from_hw) throws (1:InvalidTableOperation ouch),

    i32 range_partition_tbl_get_first_entry_handle(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt) throws (1:InvalidTableOperation ouch),

    list<i32> range_partition_tbl_get_next_entry_handles(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt, 3:EntryHandle_t entry_hdl, 4:i32 n) throws (1:InvalidTableOperation ouch),

    netbufferv4_range_partition_tbl_entry_desc_t range_partition_tbl_get_entry(1:res.SessionHandle_t sess_hdl, 2:byte dev_id, 3:EntryHandle_t entry_hdl, 4:bool read_from_hw) throws (1:InvalidTableOperation ouch),
    ...
    EntryHandle_t process_scanreq_split_tbl_set_default_action_reset_meta_serversid_remainscannum(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt) throws (1:InvalidTableOperation ouch),
    EntryHandle_t range_partition_for_scan_endkey_tbl_set_default_action_nop(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt) throws (1:InvalidTableOperation ouch),
    EntryHandle_t range_partition_tbl_set_default_action_nop(1:res.SessionHandle_t sess_hdl, 2:res.DevTarget_t dev_tgt) throws (1:InvalidTableOperation ouch),
...
# //::   if action_table_hdl: continue
    void process_scanreq_split_tbl_set_property(1:res.SessionHandle_t sess_hdl, 2:byte dev_id, 3:tbl_property_t property, 4:tbl_property_value_t value, 5:i32 prop_args) throws (1:InvalidTableOperation ouch),

    tbl_property_value_args_t process_scanreq_split_tbl_get_property(1:res.SessionHandle_t sess_hdl, 2:byte dev_id, 3:tbl_property_t property) throws (1:InvalidTableOperation ouch),
# //::   if action_table_hdl: continue
    void range_partition_for_scan_endkey_tbl_set_property(1:res.SessionHandle_t sess_hdl, 2:byte dev_id, 3:tbl_property_t property, 4:tbl_property_value_t value, 5:i32 prop_args) throws (1:InvalidTableOperation ouch),

    tbl_property_value_args_t range_partition_for_scan_endkey_tbl_get_property(1:res.SessionHandle_t sess_hdl, 2:byte dev_id, 3:tbl_property_t property) throws (1:InvalidTableOperation ouch),
# //::   if action_table_hdl: continue
    void range_partition_tbl_set_property(1:res.SessionHandle_t sess_hdl, 2:byte dev_id, 3:tbl_property_t property, 4:tbl_property_value_t value, 5:i32 prop_args) throws (1:InvalidTableOperation ouch),

    tbl_property_value_args_t range_partition_tbl_get_property(1:res.SessionHandle_t sess_hdl, 2:byte dev_id, 3:tbl_property_t property) throws (1:InvalidTableOperation ouch),
# //::   if action_table_hdl: continue
