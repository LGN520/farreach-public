...
#define CURMETHOD_ID DISTCACHE_ID
...
short switchos_dppopserver_port = -1;
short switchos_cppopserver_port = -1;
...
inline void parse_ini(const char* config_file) {
	...
	switchos_dppopserver_port = ini.get_switchos_dppopserver_port();
	switchos_cppopserver_port = ini.get_switchos_cppopserver_port();
