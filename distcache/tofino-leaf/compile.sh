...
./configure --prefix=$SDE_INSTALL --with-tofino P4_NAME=distcacheleaf P4_PATH=/home/${USER}/${SWITCH_ROOTPATH}/distcache/tofino-leaf/distcacheleaf.p4  enable_thrift=yes  P4_VERSION=p4-14
make
make install
