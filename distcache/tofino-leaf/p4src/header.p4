...
@pragma pa_solitary ingress op_hdr.optype
@pragma pa_solitary egress op_hdr.optype
header op_t op_hdr;
#ifdef RANGE_SUPPORT
...
//@pragma pa_solitary ingress inswitch_hdr.is_cached
//@pragma pa_solitary egress inswitch_hdr.is_cached
@pragma pa_no_overlay ingress inswitch_hdr.idx
@pragma pa_no_overlay egress inswitch_hdr.idx
@pragma pa_solitary ingress inswitch_hdr.idx
@pragma pa_solitary egress inswitch_hdr.idx
header inswitch_t inswitch_hdr;
header stat_t stat_hdr;
header clone_t clone_hdr;
header frequency_t frequency_hdr;
header switchload_t switchload_hdr;
