...
void get_controller_snapshotid_path(std::string &snapshotid_path) {
	GET_STRING(snapshotid_path, "/tmp/distcache/controller.snapshotid");
	return;
}

void get_controller_snapshotdata_path(std::string &snapshotdata_path, int snapshotid) {
	GET_STRING(snapshotdata_path, "/tmp/distcache/controller.snapshotdata" << snapshotid);
	return;
}
