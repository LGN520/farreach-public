...
// Change distcache.p4, common.py, and helper.h accordingly
...
#define distcache_PUTREQ_SEQ_CACHED 0x0043
// 0b0111
// 0b1111
...
#define distcache_WARMUPREQ_INSWITCH 0x0064
#define distcache_WARMUPREQ_INSWITCH_POP 0x0074
// 0b0010
#define DELREQ_SEQ 0x0002
#define DELREQ_SEQ_CASE3 0x0012
#define distcache_DELREQ_SEQ_CACHED 0x0022
// 0b1000
...
#define distcache_GETREQ_POP 0x0120
// NOTE: distcache_CACHE_POP/_ACK, distcache_CACHE_POP_FINISH/_ACK, distcache_CACHE_EVICT/_ACK only used by end-hosts
#define distcache_CACHE_POP 0x0130
#define distcache_CACHE_POP_ACK 0x0140
#define distcache_CACHE_POP_FINISH 0x0150
#define distcache_CACHE_POP_FINISH_ACK 0x0160
#define distcache_CACHE_EVICT 0x0170
#define distcache_CACHE_EVICT_ACK 0x0180
#define distcache_VALUEUPDATE_ACK 0x0190
...
control ingress {
	...
	apply(ig_port_forward_tbl); // update op_hdr.optype (update egress_port for distcache_VALUEUPDATE)
}
...
control egress {
	...
	// For distcache_GETREQ_POP, after inheriting clone_hdr.server_sid from GETREQ_INSWITCH, process_scanreq_split does NOT reset clone_hdr.server_sid by default, and it needs to invoke nop() explicitly in prepare_for_cachepop_tbl to avoid reset server_sid

	// Stage 0
	apply(access_latest_tbl); // NOTE: latest_reg corresponds to stats.validity in distcache paper, which will be used to *invalidate* the value by PUT/DELREQ
