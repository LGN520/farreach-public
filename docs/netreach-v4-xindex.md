# Tofino-based NetREACH + DPDK-based XIndex (in-memory KVS) + variable-length key-value pair w/ snapshot + control-plane-based cache update (netreach-v4-xindex)
...
- Compile in Tofino
	...
	* Test correctness
		...
		* Remove debug_hdr
	* Test cache population/eviction and crash-consistent snapshot
