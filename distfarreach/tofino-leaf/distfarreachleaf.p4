...
#define GETRES_SERVER_SEQ 0x009b
// 0b1001
...
#define PUTRES_SERVER_SEQ 0x002a
#define DELRES_SERVER_SEQ 0x003a
// 0b0000
...
#define GETRES_LARGEVALUE_SERVER_SEQ 0x0360
...
// SPINESELECT_ENTRY_NUM = 11 * MAX_SERVER_NUM < 16 * MAX_SERVER_NUM
#define SPINESELECT_ENTRY_NUM 2048
// RANGE_PARTITION_ENTRY_NUM = 19 * MAX_SERVER_NUM < 32 * MAX_SERVER_NUM
...
// HASH_PARTITION_ENTRY_NUM = 18 * MAX_SERVER_NUM < 32 * MAX_SERVER_NUM
