...
./configure --prefix=$SDE_INSTALL --with-tofino P4_NAME=distnocacheleaf P4_PATH=${SWITCH_ROOTPATH}/distnocache/tofino-leaf/distnocacheleaf.p4  enable_thrift=yes  P4_VERSION=p4-14
make
make install
