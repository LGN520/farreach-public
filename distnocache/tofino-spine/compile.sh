...
./configure --prefix=$SDE_INSTALL --with-tofino P4_NAME=distnocachespine P4_PATH=/home/${USER}/${SWITCH_ROOTPATH}/distnocache/tofino-spine/distnocachespine.p4  enable_thrift=yes  P4_VERSION=p4-14
make
make install
