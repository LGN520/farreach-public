...
echo "Copy $TMPDIRNAME/$TMPFILENAME to ${LEAFSWITCH}"
scp $TMPDIRNAME/$TMPFILENAME ${USER}@${LEAFSWITCH}:${SWITCH_ROOTPATH}/$TMPDIRNAME
#echo "Copy $TMPDIRNAME/$TMPFILENAME to ${SPINESWITCH}"
#scp $TMPDIRNAME/$TMPFILENAME ${USER}@${SPINESWITCH}:${SWITCH_ROOTPATH}/$TMPDIRNAME
