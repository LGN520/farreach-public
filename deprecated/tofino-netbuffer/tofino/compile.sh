...
./configure --prefix=$SDE_INSTALL --with-tofino P4_NAME=netbuffer P4_PATH=${SWITCH_ROOTPATH}/tofino-netbuffer/tofino/basic.p4  enable_thrift=yes  P4_VERSION=p4-14
make
make install
