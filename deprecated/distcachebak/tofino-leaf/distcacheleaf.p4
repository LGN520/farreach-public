...
//blank checksum
control distcacheleafVerifyChecksum(inout headers hdr, inout metadata meta) {
    apply {  }
}
control distcacheleafComputeChecksum(inout headers hdr, inout metadata meta) {
    apply { 	 
        update_checksum(
...
V1Switch(
distcacheleafParser(),
distcacheleafVerifyChecksum(),
distcacheleafIngress(),
distcacheleafEgress(),
distcacheleafComputeChecksum(),
distcacheleafDeparser()
) main;