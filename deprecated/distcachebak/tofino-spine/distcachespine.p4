...
//blank checksum
control distcachespineVerifyChecksum(inout headers hdr, inout metadata meta) {
    apply {  }
}
control distcachespineComputeChecksum(inout headers hdr, inout metadata meta) {
    apply { 	 
        update_checksum(
...
//switch architecture
V1Switch(
distcachespineParser(),
distcachespineVerifyChecksum(),
distcachespineIngress(),
distcachespineEgress(),
distcachespineComputeChecksum(),
distcachespineDeparser()
) main;