...
./configure --prefix=$SDE_INSTALL --with-tofino P4_NAME=distcachespine P4_PATH=${SWITCH_ROOTPATH}/distcache/tofino-spine/distcachespine.p4  enable_thrift=yes  P4_VERSION=p4-14
make
make install
