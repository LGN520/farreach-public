...
// Change distfarreachlimitleaf.p4, common.py, and helper.h accordingly
...
// RANGE_PARTITION_ENTRY_NUM = 18 * MAX_SERVER_NUM < 32 * MAX_SERVER_NUM
#define RANGE_PARTITION_ENTRY_NUM 4096
...
// HASH_PARTITION_ENTRY_NUM = 17 * MAX_SERVER_NUM < 32 * MAX_SERVER_NUM
#define HASH_PARTITION_ENTRY_NUM 4096
...
#include "p4src/regs/ratelimitload.p4"
...
control egress {
	...
	apply(ratelimitload_threshold_tbl);
	...
	apply(access_ratelimitload_tbl);
	...
	apply(drop_for_ratelimit_tbl); // before another_/eg_port_forward_tbl to avoid optype change
