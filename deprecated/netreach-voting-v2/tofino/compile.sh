...
./configure --prefix=$SDE_INSTALL --with-tofino P4_NAME=netbufferv2 P4_PATH=${SWITCH_ROOTPATH}/netreach-voting-v2/tofino/basic.p4  enable_thrift=yes  P4_VERSION=p4-14
make
make install
