...
./configure --prefix=$SDE_INSTALL --with-tofino P4_NAME=netbufferv3 P4_PATH=/home/${USER}/${SWITCH_ROOTPATH}/netreach-voting-v3/tofino/netbufferv3.p4  enable_thrift=yes  P4_VERSION=p4-14
make
make install
