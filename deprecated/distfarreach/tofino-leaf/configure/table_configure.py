...
#            self.mirror.mirror_session_create(self.sess_hdl, self.dev_tgt, info)
            ...
            if RANGE_SUPPORT == False:
                ## Table: hash_for_partition_tbl (default: nop; size: 29)
            ...
            if RANGE_SUPPORT == True:
                # Table: range_partition_tbl (default: nop; size <= 30 * 128)
                ...
                # Table: hash_partition_tbl (default: nop; size <= 29 * 128)
            ...
            # Table: snapshot_flag_tbl (default: reset_snapshot_flag; size: 8+11=19)
            ...
            # NOTE: update initial_entrynum_for_snapshot_flag = 11 in ptf_snapshotserver accordingly
            # NOTE: we do NOT need to access snapshot_flag_tbl for XXX_BEINGEVICTED_SPINE, which do NOT match the snapshot flag in ig_port_forward_tbl
            for tmpoptype in [PUTREQ_SEQ_INSWITCH, DELREQ_SEQ_INSWITCH, GETRES_LATEST_SEQ_SERVER_INSWITCH, GETRES_DELETED_SEQ_SERVER_INSWITCH, PUTREQ_LARGEVALUE_SEQ_INSWITCH, PUTREQ_SEQ_BEINGEVICTED_SPINE, PUTREQ_SEQ_CASE3_BEINGEVICTED_SPINE, DELREQ_SEQ_BEINGEVICTED_SPINE, DELREQ_SEQ_CASE3_BEINGEVICTED_SPINE, PUTREQ_LARGEVALUE_SEQ_BEINGEVICTED_SPINE, PUTREQ_LARGEVALUE_SEQ_CASE3_BEINGEVICTED_SPINE]:
            ...
            # Table: ipv4_forward_tbl (default: nop; size: 2*(18*client_physical_num)=72 < 256)
                    ...
                    for tmpoptype in [GETRES_LATEST_SEQ_SERVER, GETRES_DELETED_SEQ_SERVER, GETRES_LATEST_SEQ_SERVER_INSWITCH, GETRES_DELETED_SEQ_SERVER_INSWITCH]:
                        ...
                        if is_cached == 0:
                            ...
                            self.client.ipv4_forward_tbl_table_add_with_forward_special_get_response_to_server_and_clone_to_spine(\
                                    self.sess_hdl, self.dev_tgt, matchspec0, actnspec0)
                    for tmpoptype in [GETRES_SERVER_SEQ, SCANRES_SPLIT_SERVER, PUTRES_SERVER_SEQ, DELRES_SERVER_SEQ, WARMUPACK_SERVER, LOADACK_SERVER, GETRES_LARGEVALUE_SERVER_SEQ]:
                        matchspec0 = distfarreachleaf_ipv4_forward_tbl_match_spec_t(\
                                op_hdr_optype = convert_u16_to_i16(tmpoptype),
                                ipv4_hdr_dstAddr = ipv4addr0,
                                ipv4_hdr_dstAddr_prefix_length = 32,
            ...
            # Table: ig_port_forward_tbl (default: nop; size: 49)
            ...
            for snapshot_flag in snapshot_flag_list:
                ...
                self.client.ig_port_forward_tbl_table_add_with_update_delreq_seq_to_delreq_seq_inswitch(\
                        self.sess_hdl, self.dev_tgt, matchspec0)
                matchspec0 = distfarreachleaf_ig_port_forward_tbl_match_spec_t(\
                        op_hdr_optype = GETRES_SERVER_SEQ,
                        inswitch_hdr_snapshot_flag = snapshot_flag,
                        meta_need_recirculate = 0)
                self.client.ig_port_forward_tbl_table_add_with_update_getres_server_seq_to_getres_seq(\
                        self.sess_hdl, self.dev_tgt, matchspec0)
                matchspec0 = distfarreachleaf_ig_port_forward_tbl_match_spec_t(\
                ...
                self.client.ig_port_forward_tbl_table_add_with_update_scanres_split_server_to_scanres_split(\
                        self.sess_hdl, self.dev_tgt, matchspec0)
                matchspec0 = distfarreachleaf_ig_port_forward_tbl_match_spec_t(\
                        op_hdr_optype = PUTRES_SERVER_SEQ,
                        inswitch_hdr_snapshot_flag = snapshot_flag,
                        meta_need_recirculate = 0)
                self.client.ig_port_forward_tbl_table_add_with_update_putres_server_seq_to_putres_seq(\
                        self.sess_hdl, self.dev_tgt, matchspec0)
                matchspec0 = distfarreachleaf_ig_port_forward_tbl_match_spec_t(\
                        op_hdr_optype = DELRES_SERVER_SEQ,
                        inswitch_hdr_snapshot_flag = snapshot_flag,
                        meta_need_recirculate = 0)
                self.client.ig_port_forward_tbl_table_add_with_update_delres_server_seq_to_delres_seq(\
                        self.sess_hdl, self.dev_tgt, matchspec0)
                matchspec0 = distfarreachleaf_ig_port_forward_tbl_match_spec_t(\
                ...
                self.client.ig_port_forward_tbl_table_add_with_update_putreq_largevalue_seq_to_putreq_largevalue_seq_inswitch(\
                        self.sess_hdl, self.dev_tgt, matchspec0)
                matchspec0 = distfarreachleaf_ig_port_forward_tbl_match_spec_t(\
                        op_hdr_optype = GETRES_LARGEVALUE_SERVER_SEQ,
                        inswitch_hdr_snapshot_flag = snapshot_flag,
                        meta_need_recirculate = 0)
                self.client.ig_port_forward_tbl_table_add_with_update_getres_largevalue_server_seq_to_getres_largevalue_seq(\
                        self.sess_hdl, self.dev_tgt, matchspec0)
                matchspec0 = distfarreachleaf_ig_port_forward_tbl_match_spec_t(\
                        ...
                        meta_need_recirculate = 0)
                if snapshot_flag == 1:
                    self.client.ig_port_forward_tbl_table_add_with_update_putreq_seq_beingevicted_to_putreq_seq_case3_beingevicted(\
                            self.sess_hdl, self.dev_tgt, matchspec0)
                matchspec0 = distfarreachleaf_ig_port_forward_tbl_match_spec_t(\
                        ...
                        meta_need_recirculate = 0)
                if snapshot_flag == 1:
                    self.client.ig_port_forward_tbl_table_add_with_update_delreq_seq_beingevicted_to_delreq_seq_case3_beingevicted(\
                            self.sess_hdl, self.dev_tgt, matchspec0)
                matchspec0 = distfarreachleaf_ig_port_forward_tbl_match_spec_t(\
                        ...
                        meta_need_recirculate = 0)
                if snapshot_flag == 1:
                    self.client.ig_port_forward_tbl_table_add_with_update_putreq_largevalue_seq_beingevicted_to_putreq_largevalue_seq_case3_beingevicted(\
                            self.sess_hdl, self.dev_tgt, matchspec0)
                matchspec0 = distfarreachleaf_ig_port_forward_tbl_match_spec_t(\
                        op_hdr_optype = PUTREQ_SEQ_BEINGEVICTED_SPINE,
                        inswitch_hdr_snapshot_flag = snapshot_flag,
                        meta_need_recirculate = 0)
                self.client.ig_port_forward_tbl_table_add_with_update_putreq_seq_beingevicted_spine_to_putreq_seq_beingevicted(\
                        self.sess_hdl, self.dev_tgt, matchspec0)
                matchspec0 = distfarreachleaf_ig_port_forward_tbl_match_spec_t(\
                        op_hdr_optype = PUTREQ_SEQ_CASE3_BEINGEVICTED_SPINE,
                        inswitch_hdr_snapshot_flag = snapshot_flag,
                        meta_need_recirculate = 0)
                self.client.ig_port_forward_tbl_table_add_with_update_putreq_seq_case3_beingevicted_spine_to_putreq_seq_case3_beingevicted(\
                        self.sess_hdl, self.dev_tgt, matchspec0)
                matchspec0 = distfarreachleaf_ig_port_forward_tbl_match_spec_t(\
                        op_hdr_optype = DELREQ_SEQ_BEINGEVICTED_SPINE,
                        inswitch_hdr_snapshot_flag = snapshot_flag,
                        meta_need_recirculate = 0)
                self.client.ig_port_forward_tbl_table_add_with_update_delreq_seq_beingevicted_spine_to_delreq_seq_beingevicted(\
                        self.sess_hdl, self.dev_tgt, matchspec0)
                matchspec0 = distfarreachleaf_ig_port_forward_tbl_match_spec_t(\
                        op_hdr_optype = DELREQ_SEQ_CASE3_BEINGEVICTED_SPINE,
                        inswitch_hdr_snapshot_flag = snapshot_flag,
                        meta_need_recirculate = 0)
                self.client.ig_port_forward_tbl_table_add_with_update_delreq_seq_case3_beingevicted_spine_to_delreq_seq_case3_beingevicted(\
                        self.sess_hdl, self.dev_tgt, matchspec0)
                matchspec0 = distfarreachleaf_ig_port_forward_tbl_match_spec_t(\
                        op_hdr_optype = PUTREQ_LARGEVALUE_SEQ_BEINGEVICTED_SPINE,
                        inswitch_hdr_snapshot_flag = snapshot_flag,
                        meta_need_recirculate = 0)
                self.client.ig_port_forward_tbl_table_add_with_update_putreq_largevalue_seq_beingevicted_spine_to_putreq_largevalue_seq_beingevicted(\
                        self.sess_hdl, self.dev_tgt, matchspec0)
                matchspec0 = distfarreachleaf_ig_port_forward_tbl_match_spec_t(\
                        op_hdr_optype = PUTREQ_LARGEVALUE_SEQ_CASE3_BEINGEVICTED_SPINE,
                        inswitch_hdr_snapshot_flag = snapshot_flag,
                        meta_need_recirculate = 0)
                self.client.ig_port_forward_tbl_table_add_with_update_putreq_largevalue_seq_case3_beingevicted_spine_to_putreq_largevalue_seq_case3_beingevicted(\
                        self.sess_hdl, self.dev_tgt, matchspec0)
            ...
            for tmpoptype in [GETREQ_INSWITCH, GETRES_LATEST_SEQ_INSWITCH, GETRES_DELETED_SEQ_INSWITCH, PUTREQ_SEQ_INSWITCH, DELREQ_SEQ_INSWITCH, PUTREQ_LARGEVALUE_SEQ_INSWITCH]:
            ...
            for is_cached in cached_list:
                for validvalue in validvalue_list:
                    ...
                    self.client.access_latest_tbl_table_add_with_reset_and_get_latest(\
                            self.sess_hdl, self.dev_tgt, matchspec0)
                    # on-path in-switch invalidation for fragment 0 of PUTREQ_LARGEVALUE_SEQ_INSWITCH
                    matchspec0 = distfarreachleaf_access_latest_tbl_match_spec_t(\
            ...
            for is_cached in cached_list:
                for validvalue in validvalue_list:
                    matchspec0 = distfarreachleaf_access_largevalueseq_and_save_assignedseq_tbl_match_spec_t(\
                            op_hdr_optype = GETREQ_INSWITCH,
                            inswitch_hdr_is_cached = is_cached,
                            validvalue_hdr_validvalue = validvalue,
                            fraginfo_hdr_cur_fragidx = 0)
                    if is_cached == 1 and validvalue == 1:
                        self.client.access_largevalueseq_and_save_assignedseq_tbl_table_add_with_get_largevalueseq(\
                                self.sess_hdl, self.dev_tgt, matchspec0)
                    for tmpoptype in [GETRES_LATEST_SEQ_INSWITCH, GETRES_DELETED_SEQ_INSWITCH, PUTREQ_SEQ_INSWITCH, DELREQ_SEQ_INSWITCH]:
                        matchspec0 = distfarreachleaf_access_largevalueseq_and_save_assignedseq_tbl_match_spec_t(\
                                op_hdr_optype = tmpoptype,
                                inswitch_hdr_is_cached = is_cached,
                                validvalue_hdr_validvalue = validvalue,
                                fraginfo_hdr_cur_fragidx = 0)
                        if is_cached == 1 and validvalue == 1:
                            self.client.access_largevalueseq_and_save_assignedseq_tbl_table_add_with_reset_largevalueseq(\
                                    self.sess_hdl, self.dev_tgt, matchspec0)
                    matchspec0 = distfarreachleaf_access_largevalueseq_and_save_assignedseq_tbl_match_spec_t(\
                            op_hdr_optype = CACHE_POP_INSWITCH,
                            inswitch_hdr_is_cached = is_cached,
                    ...
                    matchspec0 = distfarreachleaf_access_largevalueseq_and_save_assignedseq_tbl_match_spec_t(\
                            ...
                            fraginfo_hdr_cur_fragidx = 0)
                    if is_cached == 1 and validvalue == 1:
                        self.client.access_largevalueseq_and_save_assignedseq_tbl_table_add_with_set_largevalueseq(\
                                self.sess_hdl, self.dev_tgt, matchspec0)
            ...
            for i in range(switch_max_vallen/8 + 1): # i from 0 to 16
                ...
                for tmpoptype in [GETRES_SEQ]:
                    ...
                    actnspec0 = distfarreacehleaf_update_pktlen_action_spec_t(val_stat_seq_udplen, val_stat_seq_iplen)
                ...
                for tmpoptype in [GETRES_LATEST_SEQ_INSWITCH_CASE1, GETRES_DELETED_SEQ_INSWITCH_CASE1, PUTREQ_SEQ_INSWITCH_CASE1, DELREQ_SEQ_INSWITCH_CASE1]:
                    ...
                    self.client.update_pktlen_tbl_table_add_with_update_pktlen(\
                            self.sess_hdl, self.dev_tgt, matchspec0, 0, actnspec0) # 0 is priority (range may be overlapping)
                # NOTE: NOT need to update pktlen for PUTREQ_SEQ_BEINGEVICTED, PUTREQ_SEQ_CASE3_BEINGEVICTED, PUTREQ_SEQ_BEINGEVICTED_SPINE, PUTREQ_SEQ_CASE3_BEINGEVICTED_SPINE
            ...
            for tmpoptype in [PUTRES_SEQ, DELRES_SEQ]:
                matchspec0 = distfarreachleaf_update_pktlen_tbl_match_spec_t(\
                        ...
                        vallen_hdr_vallen_start=0,
                        vallen_hdr_vallen_end=switch_max_vallen) # [0, 128]
                actnspec0 = distfarreachleaf_update_pktlen_action_spec_t(seq_stat_udplen, seq_stat_iplen)
                self.client.update_pktlen_tbl_table_add_with_update_pktlen(\
                        self.sess_hdl, self.dev_tgt, matchspec0, 0, actnspec0) # 0 is priority (range may be overlapping)
            # NOTE: NOT need to update pktlen for DELREQ_SEQ_BEINGEVICTED, DELREQ_SEQ_CASE3_BEINGEVICTED, DELREQ_SEQ_BEINGEVICTED_SPINE, DELREQ_SEQ_CASE3_BEINGEVICTED_SPINE
            ...
            self.client.update_pktlen_tbl_table_add_with_update_pktlen(\
                    self.sess_hdl, self.dev_tgt, matchspec0, 0, actnspec0) # 0 is priority (range may be overlapping)
            # NOTE: NOT need to update pktlen for PUTREQ_LARGEVALUE_SEQ/_CASE3, PUTREQ_LARGEVALUE_SEQ/_CASE3_BEINGEVICTED, PUTREQ_LARGEVALUE_SEQ/DELREQ_SEQ_CASE3_BEINGEVICTED_SPINE, which have been updated by spine switch
            ...
            # Table: add_and_remove_value_header_tbl (default: remove_all; 17*19=323)
            ...
            # NOTE: even for future PUTREQ_LARGE/GETRES_LARGE, as their vallen and values should be in payload, we do NOT need to update pktlen for them
            #LOADREQ, GETRES
            for tmpoptype in [PUTREQ, PUTREQ_SEQ, PUTREQ_POP_SEQ, PUTREQ_SEQ_CASE3, PUTREQ_POP_SEQ_CASE3, GETRES_LATEST_SEQ_INSWITCH_CASE1, GETRES_DELETED_SEQ_INSWITCH_CASE1, PUTREQ_SEQ_INSWITCH_CASE1, DELREQ_SEQ_INSWITCH_CASE1, GETRES_SEQ, CACHE_EVICT_LOADDATA_INSWITCH_ACK, LOADSNAPSHOTDATA_INSWITCH_ACK, GETRES_LATEST_SEQ, GETRES_DELETED_SEQ, GETRES_LATEST_SEQ_SERVER, GETRES_DELETED_SEQ_SERVER, PUTREQ_SEQ_BEINGEVICTED, PUTREQ_SEQ_CASE3_BEINGEVICTED]:
                for i in range(switch_max_vallen/8 + 1): # i from 0 to 16
                    if i == 0:
                        vallen_start = 0
                        vallen_end = 0
                                        ...
                                        for is_case1 in case1_list:
                                                ...
                                                if is_cached == 0:
                                                    ...
                                                    if validvalue == 0:
                                                        ...
                                                        if is_latest == 0:
                                                            ...
                                                            actnspec0 = distfarreachleaf_update_getreq_inswitch_to_getres_seq_by_mirroring_action_spec_t(tmp_client_sid, server_worker_port_start, tmpstat)
                                            ...
                                            if is_cached == 0 and is_hot == 0 and validvalue == 0 and is_latest == 0 and is_deleted == 0 and tmp_client_sid == 0 and is_lastclone_for_pktloss == 0 and snapshot_flag == 0 and is_case1 == 0:
                                                matchspec0 = distfarreachleaf_another_eg_port_forward_tbl_match_spec_t(\
                                                    ...
                                                    inswitch_hdr_snapshot_flag = snapshot_flag,
                                                    meta_is_case1 = is_case1)
                                                # Update GETRES_LATEST_SEQ_SERVER (by clone_i2e) as GETRES_SEQ to client
                                                self.client.another_eg_port_forward_tbl_table_add_with_update_getres_latest_seq_server_to_getres_seq(\
                                                        self.sess_hdl, self.dev_tgt, matchspec0)
                                            # size: 4
                                            ...
                                            if is_hot == 0 and validvalue == 0 and is_latest == 0 and is_deleted == 0 and tmp_client_sid == 0 and is_lastclone_for_pktloss == 0 and is_case1 == 0:
                                                matchspec0 = distfarreachleaf_another_eg_port_forward_tbl_match_spec_t(\
                                                    ...
                                                    inswitch_hdr_snapshot_flag = snapshot_flag,
                                                    meta_is_case1 = is_case1)
                                                # Update GETRES_LATEST_SEQ_SERVER_INSWITCH (by clone_i2e) as GETRES_SEQ to client
                                                self.client.another_eg_port_forward_tbl_table_add_with_update_getres_latest_seq_server_inswitch_to_getres_seq(\
                                                        self.sess_hdl, self.dev_tgt, matchspec0)
                                            ...
                                            if is_cached == 0 and is_hot == 0 and validvalue == 0 and is_latest == 0 and is_deleted == 0 and tmp_client_sid == 0 and is_lastclone_for_pktloss == 0 and snapshot_flag == 0 and is_case1 == 0:
                                                matchspec0 = distfarreachleaf_another_eg_port_forward_tbl_match_spec_t(\
                                                    ...
                                                    inswitch_hdr_snapshot_flag = snapshot_flag,
                                                    meta_is_case1 = is_case1)
                                                # Update GETRES_DELETED_SEQ_SERVER (by clone_i2e) as GETRES_SEQ to client
                                                self.client.another_eg_port_forward_tbl_table_add_with_update_getres_deleted_seq_server_to_getres_seq(\
                                                        self.sess_hdl, self.dev_tgt, matchspec0)
                                            # size: 4
                                            ...
                                            if is_hot == 0 and validvalue == 0 and is_latest == 0 and is_deleted == 0 and tmp_client_sid == 0 and is_lastclone_for_pktloss == 0 and is_case1 == 0:
                                                matchspec0 = distfarreachleaf_another_eg_port_forward_tbl_match_spec_t(\
                                                    ...
                                                    inswitch_hdr_snapshot_flag = snapshot_flag,
                                                    meta_is_case1 = is_case1)
                                                # Update GETRES_DELETED_SEQ_SERVER_INSWITCH (by clone_i2e) as GETRES_SEQ to client
                                                self.client.another_eg_port_forward_tbl_table_add_with_update_getres_deleted_seq_server_inswitch_to_getres_seq(\
                                                        self.sess_hdl, self.dev_tgt, matchspec0)
                                        ...
                                        for is_case1 in case1_list:
                                            ...
                                            if is_lastclone_for_pktloss == 0 and tmp_client_sid != 0:
                                                ...
                                                if is_cached == 0:
                                                    ...
                                                    if validvalue == 0:
                                                        ...
                                                        if snapshot_flag == 1:
                                                            # Update PUTREQ_SEQ_INSWITCH as PUTREQ_SEQ_CASE3_BEINGEVICTED to server
                                                            self.client.eg_port_forward_tbl_table_add_with_update_putreq_seq_inswitch_to_putreq_seq_case3_beingevicted(\
                                                                    self.sess_hdl, self.dev_tgt, matchspec0)
                                                        elif snapshot_flag == 0:
                                                            # Update PUTREQ_SEQ_INSWITCH as PUTREQ_SEQ_BEINGEVICTED to server
                                                            self.client.eg_port_forward_tbl_table_add_with_update_putreq_seq_inswitch_to_putreq_seq_beingevicted(\
                                                                    self.sess_hdl, self.dev_tgt, matchspec0)
                                                    elif validvalue == 1:
                                                        if snapshot_flag == 1 and is_case1 == 0:
                                                            ...
                                                            # Update PUTREQ_SEQ_INSWITCH as PUTRES_SEQ to client by mirroring
                                                            actnspec0 = distfarreachleaf_update_putreq_seq_inswitch_to_putres_seq_by_mirroring_action_spec_t(tmp_client_sid, server_worker_port_start)
                                                            self.client.eg_port_forward_tbl_table_add_with_update_putreq_seq_inswitch_to_putres_seq_by_mirroring(\
                                                                    self.sess_hdl, self.dev_tgt, matchspec0, actnspec0)
                                            ...
                                            if is_cached == 1 and is_hot == 0 and validvalue == 0 and is_latest == 0 and is_deleted == 0 and snapshot_flag == 1 and is_case1 == 0 and tmp_client_sid != 0:
                                                ...
                                                if is_lastclone_for_pktloss == 0:
                                                    ...
                                                    actnspec0 = distfarreachleaf_update_putreq_seq_inswitch_case1_to_putres_seq_by_mirroring_action_spec_t(tmp_client_sid, server_worker_port_start)
                                            ...
                                            if is_hot == 0 and is_lastclone_for_pktloss == 0 and tmp_client_sid != 0:
                                                ...
                                                if is_cached == 0:
                                                    ...
                                                    if validvalue == 0:
                                                        ...
                                                        if snapshot_flag == 1:
                                                            # Update DELREQ_SEQ_INSWITCH as DELREQ_SEQ_CASE3_BEINGEVICTED to server
                                                            self.client.eg_port_forward_tbl_table_add_with_update_delreq_seq_inswitch_to_delreq_seq_case3_beingevicted(\
                                                                    self.sess_hdl, self.dev_tgt, matchspec0)
                                                        elif snapshot_flag == 0:
                                                            # Update DELREQ_SEQ_INSWITCH as DELREQ_SEQ_BEINGEVICTED to server
                                                            self.client.eg_port_forward_tbl_table_add_with_update_delreq_seq_inswitch_to_delreq_seq_beingevicted(\
                                                                    self.sess_hdl, self.dev_tgt, matchspec0)
                                                    elif validvalue == 1:
                                                        if snapshot_flag == 1 and is_case1 == 0:
                                                            ...
                                                            # Update DELREQ_SEQ_INSWITCH as DELRES_SEQ to client by mirroring
                                                            actnspec0 = distfarreachleaf_update_delreq_seq_inswitch_to_delres_seq_by_mirroring_action_spec_t(tmp_client_sid, server_worker_port_start)
                                                            self.client.eg_port_forward_tbl_table_add_with_update_delreq_seq_inswitch_to_delres_seq_by_mirroring(\
                                                                    self.sess_hdl, self.dev_tgt, matchspec0, actnspec0)
                                            ...
                                            if is_cached == 1 and is_hot == 0 and validvalue == 0 and is_latest == 0 and is_deleted == 0 and snapshot_flag == 1 and is_case1 == 0 and tmp_client_sid != 0:
                                                ...
                                                if is_lastclone_for_pktloss == 0:
                                                    ...
                                                    actnspec0 = distfarreachleaf_update_delreq_seq_inswitch_case1_to_delres_seq_by_mirroring_action_spec_t(tmp_client_sid, server_worker_port_start)
