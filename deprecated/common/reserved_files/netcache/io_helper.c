...
void get_controller_snapshotid_path(std::string &snapshotid_path) {
	GET_STRING(snapshotid_path, "/tmp/netcache/controller.snapshotid");
	return;
}

void get_controller_snapshotdata_path(std::string &snapshotdata_path, int snapshotid) {
	GET_STRING(snapshotdata_path, "/tmp/netcache/controller.snapshotdata" << snapshotid);
	return;
}
