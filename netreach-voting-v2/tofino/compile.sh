...
make
make install
sed -e 's/TOFINO_SINGLE_DEVICE/netbuffer/g' <$SDE/pkgsrc/p4-examples/tofino/tofino_single_device.conf.in > $SDE_INSTALL/share/p4/targets/tofino/netbufferv2.conf
